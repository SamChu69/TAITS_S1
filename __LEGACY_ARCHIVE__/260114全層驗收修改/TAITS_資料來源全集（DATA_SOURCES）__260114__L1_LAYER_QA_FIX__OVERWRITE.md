...
- scope_files_output: TAITS_資料來源全集（DATA_SOURCES）__260114__L1_LAYER_QA_FIX__OVERWRITE.md
- scope_mode: FINAL QA MODE + LAYER QA MODE（L1：DataIngested 契約補強；不改寫 MASTER_CANON 主幹語義）
- version_date: 2026-01-14（Asia/Taipei）
...
7) **L1_LAYER_QA_FIX**：補強 L1（DataIngested）輸出契約欄位集合，對齊 ARCH_FLOW=7.1 與 22.3／27.2 要求（新增 fetch_window、active_version_map_ref、source_tier_used/licensing_notes_ref、trust_level、compliance_eligible、failover_event_ref），以消除 L1 契約漂移與混讀。

## C. Hash Manifest（指紋清單｜非正文）
- hash_scope: 正文區（自檔首至『# 檔尾稽核區塊（Audit Section｜非正文）』之前，不含稽核區塊）
- body_sha256: 8da88286e6ec936a5543ff7e283d0b7e33f4eb670a0a16e3474879a6f7126cd4
