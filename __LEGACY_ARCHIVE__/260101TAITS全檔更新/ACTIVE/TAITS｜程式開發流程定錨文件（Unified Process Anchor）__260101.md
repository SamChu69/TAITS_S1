...
> 說明：以下為 `TAITS｜程式開發流程定錨文件（Unified Process Anchor）__251231.md` 之原文全文，為避免舊標示/舊備註干擾裁決，本版將「單一正確口徑」置於正文；原文作為歷史證據保留。

<!--
TAITS｜ACTIVE UPDATED（單檔內嵌更新版）
產出日期：2025-12-29（Asia/Taipei）
更新規格：單檔內嵌；可更新處直接更新並避免重複；不可更新處以 Appendix 內嵌 Only-Add 全文。
來源檔：TAITS｜程式開發流程定錨文件（Unified Process Anchor）__ADDENDUM_20251228_ALLINONE_FINAL.md
-->
