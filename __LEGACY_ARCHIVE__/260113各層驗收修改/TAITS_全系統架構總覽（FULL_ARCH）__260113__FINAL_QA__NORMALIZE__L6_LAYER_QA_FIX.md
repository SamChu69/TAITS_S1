...
- `data_quality_flags[]`（正式欄位名；與 `quality_flags[]` 同義。跨模組/跨文件引用一律以 `data_quality_flags[]` 為準）
...
- BODY_SHA256：da57732b5ab1af15bab88792a929c6302cfb1f324ef62a1dd80a313babbc36a1
### 3) 覆蓋範圍（Scope）
