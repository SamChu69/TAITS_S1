# TAITS_使用者介面與人機決策規範（UI_SPEC）__260104（單一正確正文版｜覆蓋版）
...
## A. Scope（適用範圍）
- doc_key: UI_SPEC
- file: TAITS_使用者介面與人機決策規範（UI_SPEC）__260104__單一正確正文版__覆蓋版.md
- baseline_date: 2026-01-04 (Asia/Taipei)
...
- BODY_ONLY.hash_value_sha256: fc6aac681267c546403c22befc01b97b3febd95f54277dc4d7a006e31e0432ab
- FULL_EXCLUDING.scope: 全檔（排除本段內 hash_value_sha256 行，以避免自指）
- FULL_EXCLUDING.hash_value_sha256: c8c52b1da0f519131cbd7ee49ee1111f360427143b2e3a3e3b32065093e6eecc

## D. Audit Hand-off（裁決承接）
- change_id: UI_SPEC-FINALQA-260104-0001
...
- downstream_notes:
  ...
  - 若 DOCUMENT_INDEX 映射條目或檔名後綴與本覆蓋輸出不一致，應以同日（2026-01-04）版本進行映射更新，避免新對話混讀。
