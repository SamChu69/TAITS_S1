# TAITS_全系統架構總覽（FULL_ARCH）__260104__單一正確正文版
...
- scope_version_date: 2026-01-04 (Asia/Taipei)
- scope_intent: Final QA + 融合更新收斂（去混讀／語義定錨一致化／保持最大完備）
- governance_order_applied: DOCUMENT_INDEX → MASTER_ARCH → AI_GOV

### 參考：治理補強與引用一致化說明（由正文移入稽核區，避免混讀）
...
## A. Scope（適用範圍）
- scope_doc_key: FULL_ARCH
- scope_files_output: TAITS_全系統架構總覽（FULL_ARCH）__260104__單一正確正文版.md
- scope_files_source: TAITS_全系統架構總覽（FULL_ARCH）__260104.md
...
- hash_value_sha256: b6e063826900404f7cc16d4dd0062f4c609d7e9940d047d662da418d2da1b578
