# TAITS_文件索引與治理對照表（DOCUMENT_INDEX）__260104（單一正確正文版／最終覆蓋版）
...
|---|---|---|---|---|---|
| TAITS_AI_行為與決策治理最終規則全集__260104__單一正確正文版.md | AI_GOV | A+ | ACTIVE | 2026-01-04 | 全系統 AI 行為與決策治理母法 |
| TAITS_文件索引與治理對照表（DOCUMENT_INDEX）__260104__單一正確正文版__最終覆蓋版.md | DOCUMENT_INDEX | A+ | ACTIVE | 2026-01-04 | 文件位階裁決最高層（本文件） |

### 5.2 A（Constitutional / State）
| 文件名稱（檔名） | doc_key | 治理等級 | 版本狀態 | 版本日期 | 說明 |
|---|---|---|---|---|---|
| TAITS_母體總憲法與核心鐵律（MASTER_ARCH）__260104__單一正確正文版__覆蓋版.md | MASTER_ARCH | A | ACTIVE | 2026-01-04 | 人類主權、鐵律、三權分立、邊界與否決鏈 |
| TAITS_完整總架構×總流程×全資訊體系（MASTER_CANON）__260104__單一正確正文版.md | MASTER_CANON | A | ACTIVE | 2026-01-04 | L1–L11 Canonical Flow 最高總綱與全資訊體系 |
| TAITS_風險控管與合規最高否決權（RISK_COMPLIANCE）__260104__單一正確正文版__覆蓋版.md | RISK_COMPLIANCE | A | ACTIVE | 2026-01-04 | 最高否決權（PASS/VETO）、理由碼、合規保守處置 |
| TAITS_交易執行與控制規範（EXECUTION_CONTROL）__260104__單一正確正文版__覆蓋版.md | EXECUTION_CONTROL | A | ACTIVE | 2026-01-04 | 執行控制、Token、Kill Switch、Human-in-the-Loop |
| TAITS_GOVERNANCE_STATE__FREEZE_v1.0__260104__單一正確正文版__最終覆蓋版.md | GOVERNANCE_STATE | A | ACTIVE | 2026-01-04 | 治理狀態宣告（以 GOVERNANCE_STATE 為準；對變更施加門檻） |

### 5.3 B（Governance / Spec）
| 文件名稱（檔名） | doc_key | 治理等級 | 版本狀態 | 版本日期 | 說明 |
|---|---|---|---|---|---|
| TAITS_全系統架構總覽（FULL_ARCH）__260104__單一正確正文版.md | FULL_ARCH | B | ACTIVE | 2026-01-04 | 橫向模組 × 縱向層級架構地圖 |
| TAITS_系統架構與流程細化說明（ARCH_FLOW）__260104__單一正確正文版.md | ARCH_FLOW | B | ACTIVE | 2026-01-04 | 流程層細化（承接 MASTER_CANON），不得改寫 Canonical |
| TAITS_治理閘門與裁決規範（GOVERNANCE_GATE_SPEC）__260104__單一正確正文版.md | GOVERNANCE_GATE_SPEC | B | ACTIVE | 2026-01-04 | Gate 規則：完整性、引用合法性、拒絕與退回語義 |
| TAITS_版本控管、稽核與可追溯治理規範（VERSION_AUDIT）__260104__單一正確正文版__最終覆蓋版.md | VERSION_AUDIT | B | ACTIVE | 2026-01-04 | 變更帳本、回放、稽核證據、可追溯治理 |
| TAITS_資料來源全集（DATA_SOURCES）__260104__單一正確正文版.md | DATA_SOURCES | B | ACTIVE | 2026-01-04 | 官方優先、來源追溯、Fallback、Provenance |
| TAITS_TWSE交易規則參考彙編（TWSE_RULES）__260104__單一正確正文版.md | TWSE_RULES | B | ACTIVE | 2026-01-04 | 交易規則參考、觸發映射、制度快照 |
| TAITS_策略宇宙全集（STRATEGY_UNIVERSE）__260104__單一正確正文版.md | STRATEGY_UNIVERSE | B | ACTIVE | 2026-01-04 | 策略白名單、生命週期、輸出契約；策略≠下單 |
| TAITS_策略特徵與因子索引（STRATEGY_FEATURE_INDEX）__260104__單一正確正文版.md | STRATEGY_FEATURE_INDEX | B | ACTIVE | 2026-01-04 | 特徵/因子定義與審計；禁止信號化偷換 |
| TAITS_使用者介面與人機決策規範（UI_SPEC）__260104__單一正確正文版__覆蓋版.md | UI_SPEC | B | ACTIVE | 2026-01-04 | UI 決策可視化、否決呈現、Decision Trace |
| TAITS_部署、營運與日常運作規範（DEPLOY_OPS）__260104__單一正確正文版.md | DEPLOY_OPS | B | ACTIVE | 2026-01-04 | 部署、回滾、停機、Runbook、Live 運作制度 |
| TAITS_本地執行與運算環境規範（LOCAL_ENV）__260104__單一正確正文版__覆蓋版.md | LOCAL_ENV | B | ACTIVE | 2026-01-04 | 金鑰隔離、環境檢核、敏感資料治理 |

### 5.4 C（Operational / Guide｜不具治理裁決力）
| 文件名稱（檔名） | doc_key | 治理等級 | 版本狀態 | 版本日期 | 說明 |
|---|---|---|---|---|---|
| TAITS_新手教學與操作引導總則（BEGINNER_GUIDE）__260104__單一正確正文版.md | BEGINNER_GUIDE | C | ACTIVE | 2026-01-04 | 新手操作引導；不得新增治理權力 |
| README__260104__單一正確正文版.md | README | C | ACTIVE | 2026-01-04 | 專案總覽與使用方式；不得越權 |
| TAITS_PROJECT_PROMPT__260104__單一正確正文版__覆蓋版.md | PROJECT_PROMPT | C | ACTIVE | 2026-01-04 | 專案對話啟動與行為規範（操作級） |
...
### 10.1 常見工程支援文件（示例）
- TAITS｜程式開發流程定錨文件（Unified Process Anchor）__260104__單一正確正文版.md（doc_key：PROCESS_ANCHOR；不入 §5）
...
completeness_patch:
  ...
  latest_mapping_v2_full:
    ...
    - doc_key: "GOVERNANCE_STATE_FREEZE_V1"
      ...
      fix_id: "VA-METADATA_FIX-20251228-0036"
    - doc_key: "LOCAL_ENV"
      latest_artifact: "TAITS_本地執行與運算環境規範（LOCAL_ENV）__260104__單一正確正文版__覆蓋版.md"
      fix_id: "VA-METADATA_FIX-20251228-0036"
    - doc_key: "MASTER_ARCH"
      latest_artifact: "TAITS_母體總憲法與核心鐵律（MASTER_ARCH）__251219__ADDENDUM_20251227_FINAL.md"
      fix_id: "VA-METADATA_FIX-20251228-0036"
...
- 本次交付範圍：**僅 doc_key=DOCUMENT_INDEX**（本文件）之 Final QA／必要融合更新收斂。
- 生效基線：2026-01-04（Asia/Taipei）
- 覆蓋方式：以本檔全文覆蓋同名檔案（可直接覆蓋）。
- 不在本次交付範圍：其他 doc_key 文件正文內容不做任何變更（僅於本檔索引/指紋清單中被引用）。



## B. Changelog（變更清單）

- 修正：補齊並重建 §5「治理有效文件清單」之表格欄位一致性，修復既有列的欄位錯置/缺漏（含 EXECUTION_CONTROL、GOVERNANCE_STATE、LOCAL_ENV 之索引落點一致化）。
- 收斂：移除檔首重複章節（重複的「全局定錨」與「0. 文件定位」標頭），改為單一章節承載，避免同名章節散落造成混讀。
- 新增：補上「目錄（Table of Contents）」以符合 Final QA 交付要求（章節依序排列/可導航）。
- 強化：明確鎖定最終裁決序位（DOCUMENT_INDEX → MASTER_ARCH → AI_GOV）與 L9/L10/L11 跨文件語義定錨，避免後續圖表/節點命名引發漂移。
- 修正：§10 非治理文件之 PROCESS_ANCHOR doc_key 表述，改為明確 doc_key=PROCESS_ANCHOR（不入 §5）。
...
- 雜湊算法：SHA-256
- 編碼：UTF-8（以檔案原始位元組計算）
- 本文件（DOCUMENT_INDEX）之「CONTENT_SHA256」計算範圍：自檔首至 `## A. Scope（適用範圍）` 前一行（不含稽核區塊 §A–§D），以避免自我指紋遞迴。

| doc_key | 檔名 | SHA-256 |
|---|---|---|
| DOCUMENT_INDEX | （本文件）CONTENT_SHA256 | a35c4533a29d192a6941797b11c4e70beefc21cd8b4d2330789bbec9a722e8e4 |
| AI_GOV | TAITS_AI_行為與決策治理最終規則全集__260104__單一正確正文版.md | 8f323ac3fb44a575976987507422bea232f1aa9f9119a0f166c21722e6ba42e7 |
| DOCUMENT_INDEX | TAITS_文件索引與治理對照表（DOCUMENT_INDEX）__260104__單一正確正文版__最終覆蓋版.md | MISSING |
| MASTER_ARCH | TAITS_母體總憲法與核心鐵律（MASTER_ARCH）__260104__單一正確正文版__覆蓋版.md | 58effe3745a4a15d9d3bb96c4585d68f863efd748c0ddfe182f24c8f7c761b0d |
| MASTER_CANON | TAITS_完整總架構×總流程×全資訊體系（MASTER_CANON）__260104__單一正確正文版.md | 178fda0fab01b1c9375e9b338976b6e60c03028f857bb42614aedc041f28216c |
| RISK_COMPLIANCE | TAITS_風險控管與合規最高否決權（RISK_COMPLIANCE）__260104__單一正確正文版__覆蓋版.md | ef786d2c79bf48df8981530b97956ec3769310d8ca9f64740e2a8d80e3ad5f03 |
| EXECUTION_CONTROL | TAITS_交易執行與控制規範（EXECUTION_CONTROL）__260104__單一正確正文版__覆蓋版.md | 2ab148fade3f4a78f00dea930c56d1e832db991d59c6905447183c14c7a81985 |
| GOVERNANCE_STATE | TAITS_GOVERNANCE_STATE__FREEZE_v1.0__260104__單一正確正文版__最終覆蓋版.md | 24c5244ea3397dcad31f17b6a7d0e877465ae45ab3724eff6bff095b974227ce |
| FULL_ARCH | TAITS_全系統架構總覽（FULL_ARCH）__260104__單一正確正文版.md | 3b4851321701c8a65e693785614d2016b9708d5c842821c6673f88272fcf45e7 |
| ARCH_FLOW | TAITS_系統架構與流程細化說明（ARCH_FLOW）__260104__單一正確正文版.md | 594b28ad373785d1e23d04518263a7c38a17915bd21ab0f0642a5b920494f1b8 |
| GOVERNANCE_GATE_SPEC | TAITS_治理閘門與裁決規範（GOVERNANCE_GATE_SPEC）__260104__單一正確正文版.md | 1a9016ded6b5d4ee4557ca1d88f70ef29797757ff45028b3196b0d6944c9a69d |
| VERSION_AUDIT | TAITS_版本控管、稽核與可追溯治理規範（VERSION_AUDIT）__260104__單一正確正文版__最終覆蓋版.md | 94c227d2eb1d790f1d3edf565e8a15a52cd984bb47d664ce2db5325cc176a47c |
| DATA_SOURCES | TAITS_資料來源全集（DATA_SOURCES）__260104__單一正確正文版.md | 3ab1db25890ec61e15ad8091b1e340d092e093fb399527cc527b4540430d892c |
| TWSE_RULES | TAITS_TWSE交易規則參考彙編（TWSE_RULES）__260104__單一正確正文版.md | 62883b0d97091bd3209b649de929b92d0f40fefd7d628d9d0883d0d4ccecbffe |
| STRATEGY_UNIVERSE | TAITS_策略宇宙全集（STRATEGY_UNIVERSE）__260104__單一正確正文版.md | 9ce75ffa74d0dc7dafb86bbf066922194ad79813248cf7afda875d7ba8f5f330 |
| STRATEGY_FEATURE_INDEX | TAITS_策略特徵與因子索引（STRATEGY_FEATURE_INDEX）__260104__單一正確正文版.md | 42501085dca6c32a0116a043026142dd653763cd54cac1a85663f044e09e8939 |
| UI_SPEC | TAITS_使用者介面與人機決策規範（UI_SPEC）__260104__單一正確正文版__覆蓋版.md | 748b552d567376086a349d26a16da4cce846326b7ffd14c2766d0af38e89a685 |
| DEPLOY_OPS | TAITS_部署、營運與日常運作規範（DEPLOY_OPS）__260104__單一正確正文版.md | 9aea1e3117c7b421cfb82c7880102f89c86dd639ba0c705bd86664270aaba291 |
| LOCAL_ENV | TAITS_本地執行與運算環境規範（LOCAL_ENV）__260104__單一正確正文版__覆蓋版.md | 592c1c5d6fe49c43f831d4779e5ec86347153784c0ac1660da46f4dc04597e2f |
| BEGINNER_GUIDE | TAITS_新手教學與操作引導總則（BEGINNER_GUIDE）__260104__單一正確正文版.md | 540dd8de9454868563c72235ff2a565cac89f8bba7185b5c51ad363c24bd23f6 |
| README | README__260104__單一正確正文版.md | 87a2f90f8e987d286e41d5f0822aad884ed0d330b136e353d1bde5911df97c4e |
| PROJECT_PROMPT | TAITS_PROJECT_PROMPT__260104__單一正確正文版__覆蓋版.md | d933a8b76d64c9f64b0adcd8e0de92cd8bc12f86662fb0d94caaebdda4427525 |
| PROCESS_ANCHOR | TAITS｜程式開發流程定錨文件（Unified Process Anchor）__260104__單一正確正文版.md | e99d7de0f1d91a592b3e38ea0026de12eabe463738b8d3be623e30225065817c |
...
- 人類確認要求：人類最高決策者核准覆蓋後，本文件即成為 2026-01-04 基線下之唯一有效索引。
