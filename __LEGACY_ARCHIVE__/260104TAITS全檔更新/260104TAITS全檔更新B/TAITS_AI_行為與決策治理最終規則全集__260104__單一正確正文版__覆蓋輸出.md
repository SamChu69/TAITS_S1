# TAITS_AI_行為與決策治理最終規則全集__260104（單一正確正文版）
...
- scope_files_output: TAITS_AI_行為與決策治理最終規則全集__260104__單一正確正文版__覆蓋輸出.md
- scope_files_source: TAITS_AI_行為與決策治理最終規則全集__260104__單一正確正文版.md
...
- hash_value_sha256: 9fe5dd137abe91665df6ae3c0e5303a745b5969856689fd3402eca402ecf6e36

## D. Audit Hand-off（裁決承接）
- change_id: AG-FIX-260104-0032
- authority_basis: HFI（人類最高決策者明確命令｜scope=AI_GOV｜Final QA 去混讀/一致化）
- governance_order_applied: DOCUMENT_INDEX → MASTER_ARCH → AI_GOV
- downstream_notes:
  - 若 DOCUMENT_INDEX 仍指向 `TAITS_AI_行為與決策治理最終規則全集__260104.md`，請改指向本檔 `...__單一正確正文版.md` 以避免載入集合出現兩份 AI_GOV。
