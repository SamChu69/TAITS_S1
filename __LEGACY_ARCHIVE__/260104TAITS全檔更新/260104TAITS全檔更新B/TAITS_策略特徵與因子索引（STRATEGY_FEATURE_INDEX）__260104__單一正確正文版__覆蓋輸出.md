# TAITS_策略特徵與因子索引（STRATEGY_FEATURE_INDEX）__260104（單一正確正文版）
...
# Block A｜文件開頭追加：MASTER_CANON 對位指引（最大完備＋累積式更新 · 以 GOVERNANCE_STATE 現況為準（若見 治理狀態 字樣，視為歷史標記））
...
- scope_files_source: TAITS_策略特徵與因子索引（STRATEGY_FEATURE_INDEX）__260104__單一正確正文版.md
- scope_files_output: TAITS_策略特徵與因子索引（STRATEGY_FEATURE_INDEX）__260104__單一正確正文版__覆蓋輸出.md
...
- BODY_ONLY:
  ...
  - hash_value_sha256: c9bb6571453d6454a6033218b5c63b1501d1a8115444ab799e7f125b123c2eab
- FULL_EXCLUDING_HASH_VALUE_LINES:
  - scope: FULL（含稽核區塊；但排除本段所有 `hash_value_sha256:` 行以避免自指）
  - hash_value_sha256: 504b69ce2cfa6ad14e76971233ef1bbebc447ac2f5f246e1f3b1d9a8f0fe6786
