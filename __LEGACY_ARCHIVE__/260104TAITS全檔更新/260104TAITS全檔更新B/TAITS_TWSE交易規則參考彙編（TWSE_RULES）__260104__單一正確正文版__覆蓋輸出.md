# TAITS_TWSE交易規則參考彙編（TWSE_RULES）__260104（單一正確正文版）
...
- scope_files_output: TAITS_TWSE交易規則參考彙編（TWSE_RULES）__260104__單一正確正文版.md
- scope_files_source: TAITS_TWSE交易規則參考彙編（TWSE_RULES）__260104.md
...
- hash_body_only_sha256: 83bfd9da34151d1d28b4b9912aa634536c4df7fc713b718010e185c5761bb6f5
- hash_scope_secondary: FULL_EXCLUDING_HASH_VALUES（含稽核區塊；將本節內所有 hash 值行置換為 `<HASH>` 後再計算）
- hash_full_excluding_hash_values_sha256: ac937b3c45f88d5fd6e18849d2908fad1c82f33e9d3005e05beaddda9093536e
- hashing_rules:
...
- downstream_notes:
  - DOCUMENT_INDEX 若仍指向 `...TWSE_RULES）__260104.md`，建議改指向本檔 `...__單一正確正文版.md`，並將原檔封存，以避免載入集合出現兩份 TWSE_RULES。
