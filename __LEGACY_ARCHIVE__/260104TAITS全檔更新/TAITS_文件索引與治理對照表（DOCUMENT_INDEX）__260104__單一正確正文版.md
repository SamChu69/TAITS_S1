...
## 0A. 文件定位補充（Why DOCUMENT_INDEX Is Power）
...
|---|---|---|---|---|---|
| TAITS_AI_行為與決策治理最終規則全集__260104__融合更新完整版.md | AI_GOV | A+ | ACTIVE | 2026-01-02 | 全系統 AI 行為與決策治理母法 |
| TAITS_文件索引與治理對照表（DOCUMENT_INDEX）__260104__單一正確正文版.md | DOCUMENT_INDEX | A+ | ACTIVE | 2026-01-04 | 文件位階裁決最高層（本文件） |

### 5.2 A（Constitutional / State）
| 文件名稱（檔名） | doc_key | 治理等級 | 版本狀態 | 版本日期 | 說明 |
|---|---|---|---|---|---|
| TAITS_母體總憲法與核心鐵律（MASTER_ARCH）__260104.md | MASTER_ARCH | A | ACTIVE | 2026-01-04 | 人類主權、鐵律、三權分立、邊界與否決鏈 |
| TAITS_完整總架構×總流程×全資訊體系（MASTER_CANON）__260104.md | MASTER_CANON | A | ACTIVE | 2026-01-04 | L1–L11 Canonical Flow 最高總綱與全資訊體系 |
| TAITS_風險與合規最高否決權（RISK_COMPLIANCE）__260102.md | RISK_COMPLIANCE | A | ACTIVE | 2026-01-04 | 最高否決權（PASS/VETO）、理由碼、合規保守處置 |
| TAITS_交易執行與控制規範（EXECUTION_CONTROL）__260104.md | EXECUTION_CONTROL | A | ACTIVE | 2026-01-04 | 執行控制、Token、Kill Switch、Human-in-the-Loop |
| TAITS_GOVERNANCE_STATE__FREEZE_v1.0__260104.md | GOVERNANCE_STATE_FREEZE_V1 | A | ACTIVE | 2026-01-04 | 治理狀態宣告：治理狀態 狀態（以 GOVERNANCE_STATE 為準） 生效（對變更施加門檻） |

### 5.3 B（Governance / Spec）
| 文件名稱（檔名） | doc_key | 治理等級 | 顯示標籤 | 版本狀態 | 版本日期 | 說明 |
|---|---|---|---|---|---|---|
| TAITS_全系統架構總覽（FULL_ARCH）__260104.md | FULL_ARCH | B |  | ACTIVE | 2026-01-04 | 橫向模組 × 縱向層級架構地圖 |
| TAITS_系統架構與流程細化說明（ARCH_FLOW）__260104.md | ARCH_FLOW | B | B+（顯示） | ACTIVE | 2026-01-04 | 流程層細化（承接 MASTER_CANON），不得改寫 Canonical |
| TAITS_治理閘門與裁決規範（GOVERNANCE_GATE_SPEC）__260104.md | GOVERNANCE_GATE_SPEC | B |  | ACTIVE | 2026-01-04 | Gate 規則：完整性、引用合法性、拒絕與退回語義 |
| TAITS_版本控管、稽核與可追溯治理規範（VERSION_AUDIT）__260104.md | VERSION_AUDIT | B |  | ACTIVE | 2026-01-04 | 變更帳本、回放、稽核證據、可追溯治理 |
| TAITS_資料來源全集（DATA_SOURCES）__260104.md | DATA_SOURCES | B |  | ACTIVE | 2026-01-04 | 官方優先、來源追溯、Fallback、Provenance |
| TAITS_TWSE交易規則參考彙編（TWSE_RULES）__260104.md | TWSE_RULES | B |  | ACTIVE | 2026-01-04 | 交易規則參考、觸發映射、制度快照 |
| TAITS_策略宇宙全集（STRATEGY_UNIVERSE）__260102.md | STRATEGY_UNIVERSE | B |  | ACTIVE | 2026-01-04 | 策略白名單、生命週期、輸出契約；策略≠下單 |
| TAITS_策略特徵與因子索引（STRATEGY_FEATURE_INDEX）__260102.md | STRATEGY_FEATURE_INDEX | B |  | ACTIVE | 2026-01-04 | 特徵/因子定義與審計；禁止信號化偷換 |
| TAITS_使用者介面與人機決策規範（UI_SPEC）__260104.md | UI_SPEC | B |  | ACTIVE | 2026-01-04 | UI 決策可視化、否決呈現、Decision Trace |
| TAITS_部署、營運與日常運作規範（DEPLOY_OPS）__260104.md | DEPLOY_OPS | B |  | ACTIVE | 2026-01-04 | 部署、回滾、停機、Runbook、Live 運作制度 |

### 5.4 C（Operational / Guide｜不具治理裁決力）
| 文件名稱（檔名） | doc_key | 治理等級 | 版本狀態 | 版本日期 | 說明 |
|---|---|---|---|---|---|
| TAITS_新手教學與操作引導總則（BEGINNER_GUIDE）__260104.md | BEGINNER_GUIDE | C | ACTIVE | 2026-01-04 | 新手操作引導；不得新增治理權力 |
| README__260104.md | README | C | ACTIVE | 2026-01-04 | 專案總覽與使用方式；不得越權 |
| TAITS_PROJECT_PROMPT__260104.md | PROJECT_PROMPT | C | ACTIVE | 2026-01-04 | 專案對話啟動與行為規範（操作級） |
| TAITS_本地執行與運算環境規範（LOCAL_ENV）__260104.md | LOCAL_ENV | C | ACTIVE | 2026-01-04 | 金鑰隔離、環境檢核、敏感資料禁止入 repo |
...
### 10.1 常見工程支援文件（示例）
- TAITS｜程式開發流程定錨文件（Unified Process Anchor）__260104.md（建議 doc_key：PROCESS_ANCHOR；**不入 §5**）
...
|---|---|---|---|
| `AI_GOV` | `（歷史封存檔｜詳見稽核區塊）` | 最大完備＋累積式更新｜Snapshot 不裁決／Index Gate／引用最小格式 | `VA-METADATA_FIX-20251227-0014` |
| `DOCUMENT_INDEX` | `（歷史封存檔｜詳見稽核區塊）` | 最大完備＋累積式更新｜批次映射表（本次收斂） | `VA-METADATA_FIX-20251227-0018` |
| `MASTER_ARCH` | `（歷史封存檔｜詳見稽核區塊）` | 最大完備＋累積式更新｜Snapshot 不裁決／S・B+・C+ 標籤回歸 | `VA-METADATA_FIX-20251227-0015` |
| `MASTER_CANON` | `（歷史封存檔｜詳見稽核區塊）` | 最大完備＋累積式更新｜治理口徑補強（S=Label 等） | `VA-METADATA_FIX-20251227-0005` |
| `FULL_ARCH` | `（歷史封存檔｜詳見稽核區塊）` | 最大完備＋累積式更新｜DATA_UNIVERSE alias 封口／引用回歸 | `VA-METADATA_FIX-20251227-0005` |
| `ARCH_FLOW` | `（歷史封存檔｜詳見稽核區塊）` | 最大完備＋累積式更新｜口徑對齊與引用模板 | `VA-METADATA_FIX-20251227-0003` |
| `GOVERNANCE_GATE_SPEC` | `（歷史封存檔｜詳見稽核區塊）` | 最大完備＋累積式更新｜裁決字串助記化／歧義消解 | `VA-METADATA_FIX-20251227-0002` |
| `RISK_COMPLIANCE` | `（歷史封存檔｜詳見稽核區塊）` | 最大完備＋累積式更新｜S=Label 對齊／引用口徑修補 | `VA-METADATA_FIX-20251227-0008` |
| `EXECUTION_CONTROL` | `（歷史封存檔｜詳見稽核區塊）` | 最大完備＋累積式更新｜S=Label 對齊／引用口徑修補 | `VA-METADATA_FIX-20251227-0002` |
| `LOCAL_ENV` | `（歷史封存檔｜詳見稽核區塊）` | 最大完備＋累積式更新｜Evidence Chain／引用模板 | `VA-METADATA_FIX-20251227-0004` |
| `DEPLOY_OPS` | `（歷史封存檔｜詳見稽核區塊）` | 最大完備＋累積式更新｜Deploy/Ops 證據鏈最小欄位／對齊 LOCAL_ENV | `VA-METADATA_FIX-20251227-0012` |
| `UI_SPEC` | `（歷史封存檔｜詳見稽核區塊）` | 最大完備＋累積式更新｜UI Trace 最小引用欄位／Index Gate | `VA-METADATA_FIX-20251227-0011` |
| `VERSION_AUDIT` | `（歷史封存檔｜詳見稽核區塊）` | 最大完備＋累積式更新｜METADATA_FIX Ledger 批次補登 | `VA-METADATA_FIX-20251227-0001` |
| `DATA_SOURCES` | `（歷史封存檔｜詳見稽核區塊）` | 最大完備＋累積式更新｜補充條目 0/0.1（DATA_UNIVERSE=alias／引用回歸） | `VA-METADATA_FIX-20251227-0005` |
| `TWSE_RULES` | `（歷史封存檔｜詳見稽核區塊）` | 最大完備＋累積式更新｜引用口徑一致化 | `VA-METADATA_FIX-20251227-0005` |
| `STRATEGY_UNIVERSE` | `（歷史封存檔｜詳見稽核區塊）` | 最大完備＋累積式更新｜DATA_UNIVERSE alias 封口／引用回歸 DATA_SOURCES | `VA-METADATA_FIX-20251227-0006` |
| `STRATEGY_FEATURE_INDEX` | `（歷史封存檔｜詳見稽核區塊）` | 最大完備＋累積式更新｜B+ Sub-Label（bucket=B）對齊／引用模板 | `VA-METADATA_FIX-20251227-0009` |
...
| `README` | `（歷史封存檔｜詳見稽核區塊）` | 最大完備＋累積式更新｜文件清單/數量快照化／Index Gate | `VA-METADATA_FIX-20251227-0010` |
| `BEGINNER_GUIDE` | `（歷史封存檔｜詳見稽核區塊）` | 最大完備＋累積式更新｜新手入口快照化／Index Gate／引用最小格式 | `VA-METADATA_FIX-20251227-0013` |
| `GOVERNANCE_STATE` | `（歷史封存檔｜詳見稽核區塊）` | 最大完備＋累積式更新｜狀態檔快照化／Index Gate／引用最小格式 | `VA-METADATA_FIX-20251227-0016` |
...
| doc_key | latest_artifact_filename | change_summary | audit_anchor_fix_id |
|---|---|---|---|
| `DOCUMENT_INDEX` | `（歷史封存檔｜詳見稽核區塊）` | 最大完備＋累積式更新｜Latest Mapping（YAML/JSON）+ Override Patch（收斂修正版）已納入；本檔即為 latest | `VA-METADATA_FIX-20251227-0022` |
| `DEPLOY_OPS` | `（歷史封存檔｜詳見稽核區塊）` | 最大完備＋累積式更新｜Trace ID / Evidence Chain 欄位貫穿規範已納入（2025-12-28） | `VA-METADATA_FIX-20251227-0020` |
| `VERSION_AUDIT` | `（歷史封存檔｜詳見稽核區塊）` | 最大完備＋累積式更新｜Ledger 補登（0021/0022/0023）延伸批次（2025-12-28） | `VA-METADATA_FIX-20251227-0023` |
...
|---|---|---|---|---|---|
| `README` | ACTIVE | `TAITS_專案總覽與使用說明（README）__251220.md` | `README__251231.md` | `11d42db1475e` | `（歷史封存檔｜詳見稽核區塊）` |
| `AI_GOV` | ACTIVE | `TAITS_AI_行為與決策治理最終規則全集__251217.md` | `TAITS_AI_行為與決策治理最終規則全集__251231.md` | `53354789820b` | `（歷史封存檔｜詳見稽核區塊）` |
...
| `TWSE_RULES` | ACTIVE | `TAITS_TWSE交易規則參考彙編（TWSE_RULES）__251219.md` | `TAITS_TWSE交易規則參考彙編（TWSE_RULES）__251231.md` | `3dfe33220600` | `（歷史封存檔｜詳見稽核區塊）` |
| `EXECUTION_CONTROL` | ACTIVE | `TAITS_交易執行與控制規範（EXECUTION_CONTROL）__251219.md` | `TAITS_交易執行與控制規範（EXECUTION_CONTROL）__251231.md` | `b6a3ede344e7` | `（歷史封存檔｜詳見稽核區塊）` |
| `UI_SPEC` | ACTIVE | `TAITS_使用者介面與人機決策規範（UI_SPEC）__251219.md` | `TAITS_使用者介面與人機決策規範（UI_SPEC）__251231.md` | `e60eb4446ae6` | `（歷史封存檔｜詳見稽核區塊）` |
| `FULL_ARCH` | ACTIVE | `TAITS_全系統架構總覽（FULL_ARCH）__251219.md` | `TAITS_全系統架構總覽（FULL_ARCH）__251231.md` | `494d5b689e51` | `（歷史封存檔｜詳見稽核區塊）` |
| `MASTER_CANON` | ACTIVE | `TAITS_完整總架構×總流程×全資訊體系（MASTER_CANON）__251219.md` | `TAITS_完整總架構×總流程×全資訊體系（MASTER_CANON）__251231.md` | `ecd9ce9c918b` | `（歷史封存檔｜詳見稽核區塊）` |
| `DOCUMENT_INDEX` | ACTIVE | `TAITS_文件索引與治理對照表（DOCUMENT_INDEX）__251220.md` | `TAITS_文件索引與治理對照表（DOCUMENT_INDEX）__251231.md` | `d407ea013bc5` | `（歷史封存檔｜詳見稽核區塊）` |
| `BEGINNER_GUIDE` | ACTIVE | `TAITS_新手教學與操作引導總則（BEGINNER_GUIDE）__251219.md` | `TAITS_新手教學與操作引導總則（BEGINNER_GUIDE）__251231.md` | `2ea9efdfcc4c` | `（歷史封存檔｜詳見稽核區塊）` |
...
| `MASTER_ARCH` | ACTIVE | `TAITS_母體總憲法與核心鐵律（MASTER_ARCH）__251219.md` | `TAITS_母體總憲法與核心鐵律（MASTER_ARCH）__251231.md` | `0c0495f757da` | `（歷史封存檔｜詳見稽核區塊）` |
| `GOVERNANCE_GATE_SPEC` | ACTIVE | `TAITS_治理閘門與裁決規範（GOVERNANCE_GATE_SPEC）__251219.md` | `TAITS_治理閘門與裁決規範（GOVERNANCE_GATE_SPEC）__251231.md` | `d3b7ab7fbaab` | `（歷史封存檔｜詳見稽核區塊）` |
| `VERSION_AUDIT` | ACTIVE | `TAITS_版本控管、稽核與可追溯治理規範（VERSION_AUDIT）__251219.md` | `TAITS_版本控管、稽核與可追溯治理規範（VERSION_AUDIT）__251231.md` | `1f3dfb7b29e0` | `（歷史封存檔｜詳見稽核區塊）` |
| `STRATEGY_UNIVERSE` | ACTIVE | `TAITS_策略宇宙全集（STRATEGY_UNIVERSE）__251219.md` | `TAITS_策略宇宙全集（STRATEGY_UNIVERSE）__251231.md` | `4b7f6c871f4f` | `（歷史封存檔｜詳見稽核區塊）` |
| `STRATEGY_FEATURE_INDEX` | ACTIVE | `TAITS_策略特徵與因子索引（STRATEGY_FEATURE_INDEX）__251219.md` | `TAITS_策略特徵與因子索引（STRATEGY_FEATURE_INDEX）__251231.md` | `01d564ba369e` | `（歷史封存檔｜詳見稽核區塊）` |
| `ARCH_FLOW` | ACTIVE | `TAITS_系統架構與流程細化說明（ARCH_FLOW）__251219.md` | `TAITS_系統架構與流程細化說明（ARCH_FLOW）__251231.md` | `d702e88c6000` | `（歷史封存檔｜詳見稽核區塊）` |
| `DATA_SOURCES` | ACTIVE | `TAITS_資料來源全集（DATA_SOURCES）__251219.md` | `TAITS_資料來源全集（DATA_SOURCES）__251231.md` | `0a197c01b6c8` | `（歷史封存檔｜詳見稽核區塊）` |
| `DEPLOY_OPS` | ACTIVE | `TAITS_部署、營運與日常運作規範（DEPLOY_OPS）__251219.md` | `TAITS_部署、營運與日常運作規範（DEPLOY_OPS）__251231.md` | `4cee1444c6c3` | `（歷史封存檔｜詳見稽核區塊）` |
| `RISK_COMPLIANCE` | ACTIVE | `TAITS_風險與合規最高否決權（RISK_COMPLIANCE）__251219.md` | `TAITS_風險與合規最高否決權（RISK_COMPLIANCE）__251231.md` | `344cd3cb642d` | `（歷史封存檔｜詳見稽核區塊）` |
...
| `（歷史封存檔｜詳見稽核區塊）` | `TAITS_AI_行為與決策治理最終規則全集__251231.md` | `ai_route` |
| `（歷史封存檔｜詳見稽核區塊）` | `TAITS_AI_行為與決策治理最終規則全集__251231.md` | `ai_route` |
| `（歷史封存檔｜詳見稽核區塊）` | `TAITS_GOVERNANCE_STATE__FREEZE_v1.0__251231.md` | `routing_token` |
| `（歷史封存檔｜詳見稽核區塊）` | `TAITS_GOVERNANCE_STATE__FREEZE_v1.0__251231.md` | `routing_token` |
| `（歷史封存檔｜詳見稽核區塊）` | `TAITS_GOVERNANCE_STATE__FREEZE_v1.0__251231.md` | `routing_token` |
| `（歷史封存檔｜詳見稽核區塊）` | `TAITS_GOVERNANCE_STATE__FREEZE_v1.0__251231.md` | `routing_token` |
...
| `（歷史封存檔｜詳見稽核區塊）` | `TAITS_使用者介面與人機決策規範（UI_SPEC）__251231.md` | `routing_token` |
...
| `（歷史封存檔｜詳見稽核區塊）` | `TAITS_完整總架構×總流程×全資訊體系（MASTER_CANON）__251231.md` | `routing_token` |
| `（歷史封存檔｜詳見稽核區塊）` | `TAITS_文件索引與治理對照表（DOCUMENT_INDEX）__251231.md` | `routing_token` |
| `（歷史封存檔｜詳見稽核區塊）` | `TAITS_文件索引與治理對照表（DOCUMENT_INDEX）__251231.md` | `routing_token` |
| `（歷史封存檔｜詳見稽核區塊）` | `TAITS_文件索引與治理對照表（DOCUMENT_INDEX）__251231.md` | `routing_token` |
| `（歷史封存檔｜詳見稽核區塊）` | `TAITS_文件索引與治理對照表（DOCUMENT_INDEX）__251231.md` | `routing_token` |
| `（歷史封存檔｜詳見稽核區塊）` | `TAITS_文件索引與治理對照表（DOCUMENT_INDEX）__251231.md` | `routing_token` |
...
| `（歷史封存檔｜詳見稽核區塊）` | `TAITS_文件索引與治理對照表（DOCUMENT_INDEX）__251231.md` | `routing_token` |
| `（歷史封存檔｜詳見稽核區塊）` | `TAITS_文件索引與治理對照表（DOCUMENT_INDEX）__251231.md` | `routing_token` |
| `（歷史封存檔｜詳見稽核區塊）` | `TAITS_本地執行與運算環境規範（LOCAL_ENV）__251231.md` | `routing_token` |
| `（歷史封存檔｜詳見稽核區塊）` | `TAITS_母體總憲法與核心鐵律（MASTER_ARCH）__251231.md` | `routing_token` |
| `（歷史封存檔｜詳見稽核區塊）` | `TAITS_版本控管、稽核與可追溯治理規範（VERSION_AUDIT）__251231.md` | `routing_token` |
| `（歷史封存檔｜詳見稽核區塊）` | `TAITS_版本控管、稽核與可追溯治理規範（VERSION_AUDIT）__251231.md` | `routing_token` |
| `（歷史封存檔｜詳見稽核區塊）` | `TAITS_版本控管、稽核與可追溯治理規範（VERSION_AUDIT）__251231.md` | `routing_token` |
| `（歷史封存檔｜詳見稽核區塊）` | `TAITS_版本控管、稽核與可追溯治理規範（VERSION_AUDIT）__251231.md` | `routing_token` |
| `（歷史封存檔｜詳見稽核區塊）` | `TAITS_版本控管、稽核與可追溯治理規範（VERSION_AUDIT）__251231.md` | `routing_token` |
...
| `（歷史封存檔｜詳見稽核區塊）` | `TAITS_資料來源全集（DATA_SOURCES）__251231.md` | `routing_token` |
| `（歷史封存檔｜詳見稽核區塊）` | `TAITS_資料來源全集（DATA_SOURCES）__251231.md` | `routing_token` |
| `（歷史封存檔｜詳見稽核區塊）` | `TAITS_部署、營運與日常運作規範（DEPLOY_OPS）__251231.md` | `routing_token` |
...
| legacy_ref_filename | resolve_to_physical_filename | resolution_rule |
|---|---|---|
| `（歷史封存檔｜詳見稽核區塊）` | `TAITS_AI_行為與決策治理最終規則全集__251231.md` | `ai_addendum_route` |
| `TAITS_PROJECT_PROMPT__ADDENDUM_20251227_FINAL.md` | `TAITS_PROJECT_PROMPT__251231.md` | `project_prompt_addendum_route` |
| `（歷史封存檔｜詳見稽核區塊）` | `TAITS_TWSE交易規則參考彙編（TWSE_RULES）__251231.md` | `twse_rules_addendum_route` |
| `（歷史封存檔｜詳見稽核區塊）` | `TAITS_交易執行與控制規範（EXECUTION_CONTROL）__251231.md` | `exec_control_addendum_route` |
| `（歷史封存檔｜詳見稽核區塊）` | `TAITS_使用者介面與人機決策規範（UI_SPEC）__251231.md` | `ui_spec_addendum_route` |
| `（歷史封存檔｜詳見稽核區塊）` | `TAITS_全系統架構總覽（FULL_ARCH）__251231.md` | `full_arch_addendum_route` |
| `（歷史封存檔｜詳見稽核區塊）` | `TAITS_完整總架構×總流程×全資訊體系（MASTER_CANON）__251231.md` | `master_canon_addendum_route` |
| `（歷史封存檔｜詳見稽核區塊）` | `TAITS_文件索引與治理對照表（DOCUMENT_INDEX）__251231.md` | `document_index_addendum_route` |
| `（歷史封存檔｜詳見稽核區塊）` | `TAITS_新手教學與操作引導總則（BEGINNER_GUIDE）__251231.md` | `beginner_guide_addendum_route` |
| `（歷史封存檔｜詳見稽核區塊）` | `TAITS_母體總憲法與核心鐵律（MASTER_ARCH）__251231.md` | `master_arch_addendum_route` |
| `（歷史封存檔｜詳見稽核區塊）` | `TAITS_治理閘門與裁決規範（GOVERNANCE_GATE_SPEC）__251231.md` | `gate_spec_addendum_route` |
| `（歷史封存檔｜詳見稽核區塊）` | `TAITS_版本控管、稽核與可追溯治理規範（VERSION_AUDIT）__251231.md` | `version_audit_addendum_route` |
| `（歷史封存檔｜詳見稽核區塊）` | `TAITS_策略宇宙全集（STRATEGY_UNIVERSE）__251231.md` | `strategy_universe_addendum_route` |
| `（歷史封存檔｜詳見稽核區塊）` | `TAITS_策略特徵與因子索引（STRATEGY_FEATURE_INDEX）__251231.md` | `strategy_feature_index_addendum_route` |
| `（歷史封存檔｜詳見稽核區塊）` | `TAITS_系統架構與流程細化說明（ARCH_FLOW）__251231.md` | `arch_flow_addendum_route` |
| `（歷史封存檔｜詳見稽核區塊）` | `TAITS_資料來源全集（DATA_SOURCES）__251231.md` | `data_sources_addendum_route` |
| `（歷史封存檔｜詳見稽核區塊）` | `TAITS_部署、營運與日常運作規範（DEPLOY_OPS）__251231.md` | `deploy_ops_addendum_route` |
| `（歷史封存檔｜詳見稽核區塊）` | `TAITS_風險與合規最高否決權（RISK_COMPLIANCE）__251231.md` | `risk_compliance_addendum_route` |
...
| `（歷史封存檔｜詳見稽核區塊）` | `README__251231.md` | `readme_route` |
...
reference_alias_map:
  ...
  items:
    ...
    - legacy_ref_filename: "（歷史封存檔｜詳見稽核區塊）"
...
- scope_files_source: TAITS_文件索引與治理對照表（DOCUMENT_INDEX）__260104__單一正確正文版.md（本輪 Final QA 修整覆蓋輸出）
- scope_mode: FILE UPDATE MODE（融合更新／整合重排版／語義定錨一致化／Final QA）
- version_date: 2026-01-04（Asia/Taipei）

## B. Changelog（變更清單）
1) **去除新舊混讀源頭（Index 內自我重複）**：移除重複的 `doc_key/版本狀態/版本日期` 中繼區塊，並將重複的 `全局定錨（S1）` 合併為單一段落；保留 `HFI` 子章節並納入同一 S1 下。  
2) **章節同名去重**：將第二段 `0. 文件定位（Why DOCUMENT_INDEX Is Power）` 改為 `0A. 文件定位補充`，避免同名章節散落。  
3) **引用映射一致化（Single Correct Load Set）**：將索引內引用之本輪文件檔名統一收斂至 `__260104`；DOCUMENT_INDEX 自身以 `__260104__單一正確正文版.md` 為唯一載入版本。  
4) **移出補丁/封存檔名以避免混讀**：正文中凡出現 `__ADDENDUM/__APPENDIX/__ACTIVE/__POSTCHECK/__HEADERFIX` 類「歷史封存檔名」，均以中性占位符取代，並將實際檔名移至本稽核區塊「Legacy Artifact List」。  
5) **版本日期口徑統一**：將正文內版本日期顯示統一為 `2026-01-04（Asia/Taipei）`（若原文有多處不同格式，已收斂為單一口徑）。  
6) **不做摘要縮水**：本次僅進行「去混讀／去重／映射一致化／格式統一」；未變更裁決序位（DOCUMENT_INDEX → MASTER_ARCH → AI_GOV）與治理等級 bucket 的制度語義。

## C. Hash Manifest（指紋清單）
- hash_alg: sha256
- scope: BODY_ONLY（不含本稽核區塊）
- hash_value_sha256: cde6826d3c38dff29dfcf7bbf230ad432e926c79883d77440941759cb804bca4

## D. Legacy Artifact List（歷史封存檔名清單｜非正文）
> 下列為本檔正文中原出現之補丁/封存檔名（避免混讀已移出正文）。其追溯與落帳以 VERSION_AUDIT 為準。

- legacy_count: 50
- TAITS_AI_行為與決策治理最終規則全集__251217__ADDENDUM_20251227_FINAL.md
- TAITS_AI_行為與決策治理最終規則全集__251217__ADDENDUM_20251228E_FINAL.md
- TAITS_AI_行為與決策治理最終規則全集__251217__ADDENDUM_20251228H_FINAL.md
- TAITS_GOVERNANCE_STATE__FREEZE_v1.0__251220__ADDENDUM_20251227_FINAL.md
- TAITS_GOVERNANCE_STATE__FREEZE_v1.0__251220__ADDENDUM_20251228E_FINAL.md
- TAITS_GOVERNANCE_STATE__FREEZE_v1.0__251220__ADDENDUM_20251228H_FINAL.md
- TAITS_GOVERNANCE_STATE__FREEZE_v1.0__251220__ADDENDUM_20251228K_FINAL.md
- TAITS_TWSE交易規則參考彙編（TWSE_RULES）__251219__ADDENDUM_20251227_FINAL.md
- TAITS_交易執行與控制規範（EXECUTION_CONTROL）__251219__ADDENDUM_20251227_FINAL.md
- TAITS_使用者介面與人機決策規範（UI_SPEC）__251219__ACTIVE_CLEAN_INLINEAPPENDIX_20251229.md
- TAITS_使用者介面與人機決策規範（UI_SPEC）__251219__ADDENDUM_20251227_FINAL.md
- TAITS_全系統架構總覽（FULL_ARCH）__251219__ADDENDUM_20251227_FINAL.md
- TAITS_完整總架構×總流程×全資訊體系（MASTER_CANON）__251219__ACTIVE_CLEAN_INLINEAPPENDIX_20251229.md
- TAITS_完整總架構×總流程×全資訊體系（MASTER_CANON）__251219__ADDENDUM_20251227_FINAL.md
- TAITS_專案總覽與使用說明（README）__251220__ADDENDUM_20251227_FINAL.md
- TAITS_文件索引與治理對照表（DOCUMENT_INDEX）__251220__ACTIVE_20251229.md
- TAITS_文件索引與治理對照表（DOCUMENT_INDEX）__251220__ADDENDUM_20251227B_FINAL.md
- TAITS_文件索引與治理對照表（DOCUMENT_INDEX）__251220__ADDENDUM_20251228D_FINAL.md
- TAITS_文件索引與治理對照表（DOCUMENT_INDEX）__251220__ADDENDUM_20251228E_FINAL.md
- TAITS_文件索引與治理對照表（DOCUMENT_INDEX）__251220__ADDENDUM_20251228F_FINAL.md
- TAITS_文件索引與治理對照表（DOCUMENT_INDEX）__251220__ADDENDUM_20251228G_FINAL.md
- TAITS_文件索引與治理對照表（DOCUMENT_INDEX）__251220__ADDENDUM_20251228H_FINAL.md
- TAITS_文件索引與治理對照表（DOCUMENT_INDEX）__251220__ADDENDUM_20251228J_FINAL.md
- TAITS_文件索引與治理對照表（DOCUMENT_INDEX）__251220__ADDENDUM_20251228K_FINAL.md
- TAITS_文件索引與治理對照表（DOCUMENT_INDEX）__251220__ADDENDUM_20251228L_FINAL.md
- TAITS_文件索引與治理對照表（DOCUMENT_INDEX）__251220__ADDENDUM_20251228M_FINAL.md
- TAITS_文件索引與治理對照表（DOCUMENT_INDEX）__251220__ADDENDUM_20251228_FINAL.md
- TAITS_新手教學與操作引導總則（BEGINNER_GUIDE）__251219__ADDENDUM_20251227_FINAL.md
- TAITS_本地執行與運算環境規範（LOCAL_ENV）__251219__ADDENDUM_20251227_FINAL.md
- TAITS_母體總憲法與核心鐵律（MASTER_ARCH）__251219__ACTIVE_CLEAN_INLINEAPPENDIX_20251229.md
- TAITS_母體總憲法與核心鐵律（MASTER_ARCH）__251219__ADDENDUM_20251227_FINAL.md
- TAITS_治理閘門與裁決規範（GOVERNANCE_GATE_SPEC）__251219__ADDENDUM_20251227_FINAL.md
- TAITS_版本控管、稽核與可追溯治理規範（VERSION_AUDIT）__251219__ADDENDUM_20251227_FINAL.md
- TAITS_版本控管、稽核與可追溯治理規範（VERSION_AUDIT）__251219__ADDENDUM_20251228C_FINAL.md
- TAITS_版本控管、稽核與可追溯治理規範（VERSION_AUDIT）__251219__ADDENDUM_20251228H_FINAL.md
- TAITS_版本控管、稽核與可追溯治理規範（VERSION_AUDIT）__251219__ADDENDUM_20251228J_FINAL.md
- TAITS_版本控管、稽核與可追溯治理規範（VERSION_AUDIT）__251219__ADDENDUM_20251228K_FINAL.md
- TAITS_版本控管、稽核與可追溯治理規範（VERSION_AUDIT）__251219__ADDENDUM_20251228L_FINAL.md
- TAITS_版本控管、稽核與可追溯治理規範（VERSION_AUDIT）__251219__ADDENDUM_20251228M_FINAL.md
- TAITS_版本控管、稽核與可追溯治理規範（VERSION_AUDIT）__251219__ADDENDUM_20251228M_FINAL__TOPBANNER_ONLYFREEZE__20251229.md
- TAITS_版本控管、稽核與可追溯治理規範（VERSION_AUDIT）__251219__ADDENDUM_20251228_FINAL.md
- TAITS_策略宇宙全集（STRATEGY_UNIVERSE）__251219__ADDENDUM_20251227_FINAL.md
- TAITS_策略特徵與因子索引（STRATEGY_FEATURE_INDEX）__251219__ADDENDUM_20251227_FINAL.md
- TAITS_系統架構與流程細化說明（ARCH_FLOW）__251219__ADDENDUM_20251227_FINAL.md
- TAITS_資料來源全集（DATA_SOURCES）__251219__ADDENDUM_0_1_FINAL.md
- TAITS_資料來源全集（DATA_SOURCES）__251219__ADDENDUM_0_2B_FINAL.md
- TAITS_資料來源全集（DATA_SOURCES）__251219__ADDENDUM_0_2C_FINAL.md
- TAITS_部署、營運與日常運作規範（DEPLOY_OPS）__251219__ADDENDUM_20251227_FINAL.md
- TAITS_部署、營運與日常運作規範（DEPLOY_OPS）__251219__ADDENDUM_20251228_FINAL.md
- TAITS_風險與合規最高否決權（RISK_COMPLIANCE）__251219__ADDENDUM_20251227_FINAL.md

## E. Audit Hand-off（裁決承接）
- change_id: DI-FINALQA-260104-0024
- authority_basis: HFI（人類最高決策者明確命令｜scope=DOCUMENT_INDEX｜Final QA 清理新舊混讀並收斂為單一正文）
- governance_order_applied: DOCUMENT_INDEX → MASTER_ARCH → AI_GOV
- downstream_notes:
  - 下一優先檔案（P0）：README__260104.md（移除正文 Freeze 標記語義，保留於稽核區塊或改為治理狀態中性表述）
  - 其後依序：Unified Process Anchor → FULL_ARCH → VERSION_AUDIT → DEPLOY_OPS → EXECUTION_CONTROL → TWSE_RULES
