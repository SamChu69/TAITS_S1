# TAITS_資料來源全集（DATA_SOURCES）__260104（單一正確正文版）
...
裁決序位：DOCUMENT_INDEX → MASTER_ARCH → AI_GOV → DATA_SOURCES（本檔）  
...
- 本文件為單一正確正文版；任何歷史狀態標記不構成正文裁決依據（以 DOCUMENT_INDEX／MASTER_ARCH／AI_GOV／DATA_SOURCES 為準）。  
...
- scope_files_output: TAITS_資料來源全集（DATA_SOURCES）__260104__單一正確正文版.md
- scope_files_source: TAITS_資料來源全集（DATA_SOURCES）__260104.md
...
- hash_value_sha256: 2af52c7324e5b52c5cf9f34176e3c70b25871c8172cd5a11e8bf51008e119db1

## D. Audit Hand-off（裁決承接）
- change_id: DS-FIX-260104-0039
...
- downstream_notes:
  - DOCUMENT_INDEX 若仍指向 `...DATA_SOURCES）__260104.md`，建議改指向本檔 `...__單一正確正文版.md` 以避免載入集合出現兩份 DATA_SOURCES。
