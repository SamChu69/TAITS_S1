...
裁決序位：DOCUMENT_INDEX → MASTER_ARCH → AI_GOV → BEGINNER_GUIDE（本檔）  
...
- 本文件為單一正確正文版；任何歷史狀態標記不構成正文裁決依據（以 DOCUMENT_INDEX／MASTER_ARCH／AI_GOV／BEGINNER_GUIDE 為準）。  
- 本文件為操作引導；不構成策略/交易建議。  
...
- scope_files_output: TAITS_新手教學與操作引導總則（BEGINNER_GUIDE）__260104__單一正確正文版.md
...
- hash_value_sha256: 76f626e97625c08e2b9a2342c214bdb8ca750aca540955fccd752d295ca30010
