...
裁決序位：DOCUMENT_INDEX → MASTER_ARCH → AI_GOV → RISK_COMPLIANCE → TWSE_RULES（本檔）  
...
- 本文件為單一正確正文版；任何歷史狀態標記不構成正文裁決依據（以 DOCUMENT_INDEX／MASTER_ARCH／AI_GOV／RISK_COMPLIANCE／TWSE_RULES 為準）。  
...
- hash_value_sha256: 84179f1655b5d15cc442306c1b6f08020e1c5860b7674f55f84f9848151a5858
