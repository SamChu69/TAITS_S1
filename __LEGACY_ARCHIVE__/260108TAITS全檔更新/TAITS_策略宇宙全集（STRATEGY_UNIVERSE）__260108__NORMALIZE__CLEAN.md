...
### 1) Changelog
- 2026-01-08｜NORMALIZE｜正文去重收斂、移除治理補丁/Label/Alias/附錄 G、更新版本日期、統一引用口徑（L1–L11 以 MASTER_CANON 為唯一正文來源）。

### 2) 指紋清單（Hash Manifest）
- BODY_SHA256: 873affc49c7cfef6efa6fdfe39fce6667988358039427fd47a9da18848157ffc

### 3) Scope（本次變更範圍）
- 僅進行正文正常化：去重、結構重排、移除不該存在之治理補丁段落與跨文件助記內容。
