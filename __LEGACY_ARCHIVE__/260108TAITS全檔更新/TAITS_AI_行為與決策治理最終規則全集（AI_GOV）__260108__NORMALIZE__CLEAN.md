...
- **目的**：產出「人類可讀」且「可追蹤」的完整投資報告，用於人類裁決者在 L10 進行最終裁決之前的資訊理解與方案評估。
- **必備內容（不可省略）**  
...
- **輸出定位**：L9 是「人類裁決者可讀之投資報告」，不是 Gate、不是下單、不是稽核。
...
- **L11 必須是「雙料輸出」**  
  1. **人類可讀（Human-Readable）**：讓人類能看懂每層做了什麼、為什麼、依據是什麼、哪裡不確定  
...
- BODY_SHA256: 8ad1b4d8d9f519a972eada00ae5cc8d9b218a9f03c380498daf04e5e05851eeb
