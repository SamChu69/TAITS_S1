...
- 對齊（Align）：更新文件頭基線日期與版本日期為 2026-01-08（Asia/Taipei），並固定裁決序位口徑為 DOCUMENT_INDEX → MASTER_ARCH → AI_GOV。
- 稽核（Audit）：清除 Legacy Snapshot／補丁式引用塊；檔尾僅保留稽核四件套。

### 2) 指紋清單（Hash Manifest）
- HASH_METHOD：SHA-256（UTF-8，LF）
- BODY_SHA256：19b13816fc933619637a5a9b04e596d273e76d6f4ccbdcb1fd82a05a27fda1fd
