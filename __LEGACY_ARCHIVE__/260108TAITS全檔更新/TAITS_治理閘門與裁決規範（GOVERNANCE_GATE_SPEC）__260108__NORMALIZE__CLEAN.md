...
- 裁決序位：依序為 DOCUMENT_INDEX、MASTER_ARCH、AI_GOV
...
- 版本更新：本文件版本日期更新為 2026-01-08（Asia/Taipei）。

### 2) 指紋清單（Hash Manifest）
- HASH_METHOD：SHA-256（UTF-8，LF）
- BODY_SHA256：24731128f5590462dd569c985d8e383d29c36396c23275eced30059a6b37d6bb
