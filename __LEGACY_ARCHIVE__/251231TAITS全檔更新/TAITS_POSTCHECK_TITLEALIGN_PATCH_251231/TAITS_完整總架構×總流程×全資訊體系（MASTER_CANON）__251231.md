...
> 【Only-Add｜等級標示封口】  
> Boot Procedure 中括號/括弧內之等級標示屬「提示標籤（Label）」，不得作為治理等級（bucket）裁決依據。  
> 任何文件之 A+ / A / B / C bucket 一律回歸 `DOCUMENT_INDEX` 之 Authoritative Index 判定；若出現張力，依 DOCUMENT_INDEX §6 採保守處置。
