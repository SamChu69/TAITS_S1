...
（整併更新 2025-12-28｜Only-Add｜DOCUMENT_INDEX｜Mapping Normalization 完）
---
...
> 稽核對位：VERSION_AUDIT｜附錄 A｜METADATA_FIX Ledger（條目：`VA-METADATA_FIX-20251228-0010`）  
...
- 本文件 `doc_key` 既有標示為 `DOCUMENT_INDEX`；本 整併更新 仍以 Index Gate 口徑再次鎖定其引用端合法身份。
