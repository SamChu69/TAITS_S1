...
> 【2025-12-29｜CONSOLIDATED EDITION｜Human Sovereign Command】
> 本文件已將歷次補充/附錄/修補內容「整併為同一份完整正文」，以降低閱讀與引用歧義。
> 本次整併原則：不新增制度、不刪減規範；僅做結構重排、段落合併、標題去附錄化。
