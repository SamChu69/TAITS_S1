...
## VA-STRUCT_REWRITE-20251229-0001｜全量整併直覆蓋批次（Consolidated Direct Overwrite Batch）

- batch_id：BATCH-20251229-CONSOLIDATED-DIRECT-0001
- governance_state：UNFREEZE v1.2（timeboxed）→ Re-Freeze v1.0
- scope：ACTIVE 全數文件（含 Process Anchor）同名覆蓋
- change_types：Reorder / Merge / Relocation / Formatting Normalization
- prohibitions：No-new-semantics / No-deletion / No-overwrite-of-rules
- audit_anchor：VA-STRUCT_REWRITE-20251229-0001
- evidence：
  - 本更新包內含：TAITS_UPDATE_MANIFEST__20251229__CONSOLIDATED_DIRECT_FINAL
  - 各文件末段保全原始 Only-Add 標頭（版本整併紀錄）供稽核比對
