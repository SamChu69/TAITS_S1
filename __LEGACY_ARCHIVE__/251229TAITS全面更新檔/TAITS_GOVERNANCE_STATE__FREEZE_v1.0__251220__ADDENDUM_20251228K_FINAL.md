...
> 稽核對位：VERSION_AUDIT｜附錄 A｜METADATA_FIX Ledger（條目：`VA-METADATA_FIX-20251228-0002`）  
...
- 本文件 `doc_key` 既有標示為 `GOVERNANCE_STATE_FREEZE_V1`；本 整併更新 仍以 Index Gate 口徑再次鎖定其引用端合法身份。
