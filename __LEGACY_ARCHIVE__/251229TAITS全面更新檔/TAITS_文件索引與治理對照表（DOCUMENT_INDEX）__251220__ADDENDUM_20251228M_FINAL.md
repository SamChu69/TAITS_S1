...
## Z9. 2025-12-29｜全量整併直覆蓋（Consolidated Direct Overwrite）納管聲明

- batch_id：BATCH-20251229-CONSOLIDATED-DIRECT-0001
- audit_anchor：VA-STRUCT_REWRITE-20251229-0001
- 納管範圍：ACTIVE 全數文件（同名覆蓋）
- 變更性質：結構整併（章節重排/段落合併/搬移/格式統一）
- 禁止事項：不得新增制度、不得刪減規範、不得偷換既有語義
- 治理狀態：本批次以 `TAITS_GOVERNANCE_STATE__UNFREEZE_v1.2__20251229_FINAL.md` 受控解凍；交付後即回復 Freeze v1.0

### Z9.1 新增治理狀態裁決文件（ACTIVE 納管）
- `TAITS_GOVERNANCE_STATE__UNFREEZE_v1.2__20251229_FINAL.md`（doc_key：GOVERNANCE_STATE_UNFREEZE_V1X）
