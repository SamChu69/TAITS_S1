...
# Addendum 2025-12-29｜Only-Add：治理狀態切換（UNFREEZE v1.1）納管登錄
...
- 檔名：TAITS_GOVERNANCE_STATE__UNFREEZE_v1.1__20251229_FINAL.md
...
在 UNFREEZE v1.1 Timebox 內：

- 允許對「全部 ACTIVE 文件（以本 DOCUMENT_INDEX 為準）」進行結構性重編，
  包含但不限於：去附錄化、正文整併重編、移除被最新內容取代之舊段落、章節重排與標題整併。
- 禁止弱化或取消：Risk/Compliance 最高否決權、L10 Human Decision、人類主權與可稽核性。

Timebox 結束後：

- 必須依 TAITS_GOVERNANCE_STATE__UNFREEZE_v1.1__20251229_FINAL.md 之 Re-Freeze 條件完成再封版裁決與留痕；
- 否則不得再進行結構性重編。
