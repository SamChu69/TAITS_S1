# TAITS｜全文件彙編本（REFERENCE_COMPILATION）

- 基線日期：2026-01-06（Asia/Taipei）
- 生成日期：2026-01-07
- 性質：**彙編閱讀版（Reference Compilation）**
- 治理地位：**非 Authoritative Index／非治理正文**（不改寫 doc_key=DOCUMENT_INDEX 所定 ACTIVE=21 與裁決序位）
- 用途：提供單一檔案閱讀/搜尋；所有治理裁決仍以各 doc_key 原檔為準。
- 裁決序位（不變）：DOCUMENT_INDEX → MASTER_ARCH → AI_GOV

---

## 重要聲明（必讀）

1) 本檔僅為「彙編閱讀版」，**不會、也不得**取代任何治理有效文件之現行正文。
2) 本檔除「導覽與指紋」段落外，其餘內容皆以 **來源快照（Source Snapshot｜非本檔正文）** 方式逐檔收錄，避免正文/稽核邊界混讀。
3) 若要讓「合併單檔」成為治理正文，必須先由 DOCUMENT_INDEX 正式納入並完成治理裁決承接（屬結構性變更）。

## 導覽（收錄順序）

1. [AI_GOV｜TAITS_AI_行為與決策治理最終規則全集（AI_GOV）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md](#snap-ai-gov)
2. [DOCUMENT_INDEX｜TAITS_文件索引與治理對照表（DOCUMENT_INDEX）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md](#snap-document-index)
3. [MASTER_ARCH｜TAITS_母體總憲法與核心鐵律（MASTER_ARCH）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md](#snap-master-arch)
4. [MASTER_CANON｜TAITS_完整總架構×總流程×全資訊體系（MASTER_CANON）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md](#snap-master-canon)
5. [FULL_ARCH｜TAITS_全系統架構總覽（FULL_ARCH）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md](#snap-full-arch)
6. [ARCH_FLOW｜TAITS_系統架構與流程細化說明（ARCH_FLOW）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md](#snap-arch-flow)
7. [RISK_COMPLIANCE｜TAITS_風險控管與合規最高否決權（RISK_COMPLIANCE）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md](#snap-risk-compliance)
8. [GOVERNANCE_GATE_SPEC｜TAITS_治理閘門與裁決規範（GOVERNANCE_GATE_SPEC）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md](#snap-governance-gate-spec)
9. [EXECUTION_CONTROL｜TAITS_交易執行與控制規範（EXECUTION_CONTROL）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md](#snap-execution-control)
10. [UI_SPEC｜TAITS_使用者介面與人機決策規範（UI_SPEC）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md](#snap-ui-spec)
11. [DEPLOY_OPS｜TAITS_部署、營運與日常運作規範（DEPLOY_OPS）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md](#snap-deploy-ops)
12. [LOCAL_ENV｜TAITS_本地執行與運算環境規範（LOCAL_ENV）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md](#snap-local-env)
13. [VERSION_AUDIT｜TAITS_版本控管、稽核與可追溯治理規範（VERSION_AUDIT）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md](#snap-version-audit)
14. [DATA_SOURCES｜TAITS_資料來源全集（DATA_SOURCES）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md](#snap-data-sources)
15. [TWSE_RULES｜TAITS_TWSE交易規則參考彙編（TWSE_RULES）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md](#snap-twse-rules)
16. [STRATEGY_UNIVERSE｜TAITS_策略宇宙全集（STRATEGY_UNIVERSE）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md](#snap-strategy-universe)
17. [STRATEGY_FEATURE_INDEX｜TAITS_策略特徵與因子索引（STRATEGY_FEATURE_INDEX）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md](#snap-strategy-feature-index)
18. [GOVERNANCE_STATE｜TAITS_GOVERNANCE_STATE__FREEZE_v1.0__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md](#snap-governance-state)
19. [BEGINNER_GUIDE｜TAITS_新手教學與操作引導總則（BEGINNER_GUIDE）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md](#snap-beginner-guide)
20. [PROCESS_ANCHOR｜TAITS｜程式開發流程定錨文件（Unified Process Anchor）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md](#snap-process-anchor)
21. [README｜README__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md](#snap-readme)
22. [TAITS_PROJECT_PROMPT｜TAITS_PROJECT_PROMPT__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md](#snap-taits-project-prompt)

## 指紋清單（Hash Manifest）

- HASH_METHOD：SHA-256（UTF-8，LF）
- AI_GOV｜TAITS_AI_行為與決策治理最終規則全集（AI_GOV）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md｜SHA256=da4b97ea20ce99c0d5dbdc776f63369299523eb83899f5e81c8d6dfec045d4f9
- DOCUMENT_INDEX｜TAITS_文件索引與治理對照表（DOCUMENT_INDEX）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md｜SHA256=9d0caa3526a23cee3f1995c0aa4b7188e8a0f8a9113ea50dc86465e2ee851f84
- MASTER_ARCH｜TAITS_母體總憲法與核心鐵律（MASTER_ARCH）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md｜SHA256=8f4456c62dfa03ef1c72b1f5dc4bc7568e5f91f28387061ee17b2815f9f25e04
- MASTER_CANON｜TAITS_完整總架構×總流程×全資訊體系（MASTER_CANON）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md｜SHA256=5998e8233638d9d4fb2aa6702845c1c7fba76437a449c8cd263d80838826f2fc
- FULL_ARCH｜TAITS_全系統架構總覽（FULL_ARCH）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md｜SHA256=9670cf9ea9a405540377a92204bd3d545b4140a56d123f13158d0daf1e679243
- ARCH_FLOW｜TAITS_系統架構與流程細化說明（ARCH_FLOW）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md｜SHA256=e425aa27efa5e3017fe1cf492736c0894e1a286d66b7453143b82eb8dff948ce
- RISK_COMPLIANCE｜TAITS_風險控管與合規最高否決權（RISK_COMPLIANCE）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md｜SHA256=de49801b32f8486a345e9a9dd49b65a7d31cac33f5e733cbda388a5cb6ac765a
- GOVERNANCE_GATE_SPEC｜TAITS_治理閘門與裁決規範（GOVERNANCE_GATE_SPEC）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md｜SHA256=bf9b0cf310150262a058163a593f1854d4b921069a28337f773536e7350e50d7
- EXECUTION_CONTROL｜TAITS_交易執行與控制規範（EXECUTION_CONTROL）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md｜SHA256=17ba6a170d735351e127e0ca076b8c34bc5a2122269dc5169970d1ed2f934e91
- UI_SPEC｜TAITS_使用者介面與人機決策規範（UI_SPEC）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md｜SHA256=128be74a467000e6f43b29fa6ba8ba76cee4c1ddf91535214ae77a164f74e0ed
- DEPLOY_OPS｜TAITS_部署、營運與日常運作規範（DEPLOY_OPS）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md｜SHA256=ae49252075f660fa798d2f90b73b4cb8cbfad50420d28cd9421ba3cace7ce381
- LOCAL_ENV｜TAITS_本地執行與運算環境規範（LOCAL_ENV）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md｜SHA256=0d46c8b2dad98f2540aa3724b278b21921cac9f13569a7bbf7c735af3ff722af
- VERSION_AUDIT｜TAITS_版本控管、稽核與可追溯治理規範（VERSION_AUDIT）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md｜SHA256=ae67e70cae509914ba806a4fce527ac829cb8784dff5b2045c67a4974be5e972
- DATA_SOURCES｜TAITS_資料來源全集（DATA_SOURCES）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md｜SHA256=af5c2743cb2fdfdde649260455891d6f3ef083468338be4fe693809256f28631
- TWSE_RULES｜TAITS_TWSE交易規則參考彙編（TWSE_RULES）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md｜SHA256=7261c05430860240c75fd43e05a069b17ce138df7b4a6fc6c32552e84added74
- STRATEGY_UNIVERSE｜TAITS_策略宇宙全集（STRATEGY_UNIVERSE）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md｜SHA256=9017b87401f472fdfbd0e15d2a850e60d7b96bec9f40fbb3485fb8f3ef5d923e
- STRATEGY_FEATURE_INDEX｜TAITS_策略特徵與因子索引（STRATEGY_FEATURE_INDEX）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md｜SHA256=78f5b198319ea7c698c56d9cdefb03a32ba6c362a533d8c457019d5a126cb2e1
- GOVERNANCE_STATE｜TAITS_GOVERNANCE_STATE__FREEZE_v1.0__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md｜SHA256=1ee6547bb3f45a7f3291457962651bc49927cac1a0f3924c81792237802755e9
- BEGINNER_GUIDE｜TAITS_新手教學與操作引導總則（BEGINNER_GUIDE）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md｜SHA256=7dd1f25c27cc1031272a8a7b1bfaba84a532ab3b2095a5664bf9cf24d06b1a58
- PROCESS_ANCHOR｜TAITS｜程式開發流程定錨文件（Unified Process Anchor）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md｜SHA256=b3d9d1db2238ed58d49bae0cbdea4d8fd64de31dffdade9fedb8d738d67cc281
- README｜README__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md｜SHA256=385d165f7330bc366dc435f62eeff85cc627bef1b830b6adeb20beea9655f974
- TAITS_PROJECT_PROMPT｜TAITS_PROJECT_PROMPT__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md｜SHA256=ca6536ca8b33cadd4e0e74157e3d2698ba13a35ff9003ea0bb73fe1c6b7cccea

## 來源快照區（Source Snapshots｜非本檔正文）

以下各段為逐檔原文快照收錄。為避免 markdown 標題層級互相干擾，本彙編以分隔線清楚切分；
若你在此檔閱讀到任何疑似衝突或重複敘述，請回到該 doc_key 原檔，以裁決序位鏈處理。

---

### SNAP-AI_GOV（TAITS_AI_行為與決策治理最終規則全集（AI_GOV）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md）
<a id="snap-ai-gov"></a>

- 來源檔名：TAITS_AI_行為與決策治理最終規則全集（AI_GOV）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md
- 來源指紋：SHA-256=da4b97ea20ce99c0d5dbdc776f63369299523eb83899f5e81c8d6dfec045d4f9
...
> - 修正：若原檔存在稽核區塊或留痕段落，已以 Legacy Snapshot 承接於檔尾稽核區塊，避免正文／稽核邊界混讀。
> - 保留：AI_GOV 規則條款全量承接，不做摘要縮水；僅做去混讀與引用一致化。
>
>
> ### 2) 指紋清單（Hash Manifest）
> - HASH_METHOD：SHA-256（UTF-8，LF）
> - BODY_SHA256：2f45a5ddecf01f3ec61063ec18b3c604faa53c6fead10b68eb8f929064ddf770
> - LEGACY_AUDIT_SHA256：5fb2d7dcb84fef0688dde938170438b4aa8929131075318cf77fcdc278f02af2
>
> ### 3) 適用範圍（Scope）
> 本次覆蓋版修正範圍僅限於 doc_key=AI_GOV：
> - 治理裁決序位表示法一致化（箭頭鏈口徑）
...
> - AI_GOV 為最高母法之一；但若與 DOCUMENT_INDEX 或 MASTER_ARCH 發生衝突，裁決序位固定為：DOCUMENT_INDEX → MASTER_ARCH → AI_GOV。
...
> > - scope_files_output: TAITS_AI_行為與決策治理最終規則全集__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106.md
> > - scope_files_source: TAITS_AI_行為與決策治理最終規則全集__260104__單一正確正文版__覆蓋輸出.md（作為本次輸入基線）
> > - scope_mode: FILE UPDATE MODE（融合更新／整合重排版／語義定錨一致化／Final QA）
> > - version_date: 2026-01-06（Asia/Taipei）
> > 
> > ## B. Changelog（變更清單）
> > 1) **去混讀修正**：移除/中性化正文中作為補丁標記的字樣（Addendum/Appendix/Only-Add/Freeze 等），改為「融合承接/附錄/累積式更新/治理狀態」等不造成新舊混讀的表述；不刪減規則內容。  
> > 2) **版本/檔名一致化**：將正文內殘留的 `__260102`、舊日期引用統一為 `__260104`／2026-01-04（Asia/Taipei），避免跨檔案引用錯亂。  
> > 3) **稽核段落單一化**：以本檔末端單一稽核區塊承接（留痕與正文分離）。
> > 
> > 4) **去混讀結構收斂**：將「工程附錄（Engineering Annex）」移入本檔稽核區塊（非正文），避免其被誤讀為正文裁決依據；正文 hash 以稽核區塊前內容為準。
> > 5) **語彙去混讀**：正文中「新附錄」更新型態改寫為「新參考區（非正文）」以避免與補丁式 Appendix/附錄語義混讀；不影響最大完備＋累積式更新原則。
> > 
> > 6) **Final QA 基線更新（260106）**：統一版本日期為 2026-01-06（Asia/Taipei），合併重複 metadata 區塊（保留所有唯一欄位於檔頭），並更新稽核區塊之 Scope/Hand-off；正文 hash 重新計算。
> > ## C. Hash Manifest（指紋清單）
> > - hash_alg: sha256
> > - scope: BODY_ONLY（不含本稽核區塊）
> > - hash_value_sha256: e230f719cb8677d61f4b81133b5d8c5c736ec5131abe830b5f24231dc749c1af
> > 
> > ## D. Audit Hand-off（裁決承接）
> > - change_id: AG-FIX-260106-0001
> > - authority_basis: HFI（人類最高決策者明確命令｜scope=AI_GOV｜Final QA 去混讀/一致化）
> > - governance_order_applied: DOCUMENT_INDEX → MASTER_ARCH → AI_GOV
> > - downstream_notes:
> >   - 若 DOCUMENT_INDEX 仍指向舊 AI_GOV 檔名，請改指向本次輸出 `TAITS_AI_行為與決策治理最終規則全集__260106__...__FINALQA_260106.md`，避免載入集合出現多份 AI_GOV。
> > 
> > ## E. 工程附屬資料（Engineering Annex｜非正文）
> > 
> > > 本區塊保存歷史範本與工程相容性資訊；不構成新增治理規則。為避免新舊混讀：本區塊不參與正文裁決。
> > 
...
### SNAP-DOCUMENT_INDEX（TAITS_文件索引與治理對照表（DOCUMENT_INDEX）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md）
<a id="snap-document-index"></a>

- 來源檔名：TAITS_文件索引與治理對照表（DOCUMENT_INDEX）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md
- 來源指紋：SHA-256=9d0caa3526a23cee3f1995c0aa4b7188e8a0f8a9113ea50dc86465e2ee851f84
...
>
> ### 1) 變更清單（Changelog）
> - 修正：將 doc_key=DOCUMENT_INDEX 之「Authoritative Index（ACTIVE=21）」中，已完成 Final QA 清理版本之檔名統一指向現行覆蓋輸出（優先採用 __CLEAN_260107 版本；避免 __PATCH1 版本作為現行引用）。
...
> ### 2) 指紋清單（Hash Manifest）
> - HASH_METHOD：SHA-256（UTF-8，LF）
> - BODY_SHA256：8d26c60d03ce99e399be3b25a69d654312249dc8903d67f9b0f325f7c12632f7
> - LEGACY_AUDIT_SHA256：d0cf32a7b8e11db04ad5dfad5a7f00585144cd2a4f3584357e78b7243e963661
>
> ### 3) 適用範圍（Scope）
...
> > ## A. Scope（適用範圍）
> > 
> > - 本次交付範圍：**僅 doc_key=DOCUMENT_INDEX（本文件）**。
> >   - 目的：Final QA 收斂，消除跨文件混讀風險、索引口徑漂移與檔名對照不一致。
> >   - 變更類型：
> >     1) §5 Authoritative Index 檔名全面對齊「現行覆蓋輸出」命名（`__覆蓋輸出.md`）。
> >     2) 將「工程附錄（Engineering Annex｜非正文）」由正文區移入稽核承接（§D.2），確保正文僅保留可裁決語義。
> >     3) 同步更新本檔目錄與稽核區塊（§B–§D）以維持單一口徑。
> > - 不在本次交付範圍：其他 doc_key 文件正文內容**不做任何修改**（僅於本檔索引與指紋清單中被引用/校驗）。
> > - 版本基線承接：2026-01-06（Asia/Taipei）；本次為 2026-01-06 之 Final QA 收斂覆蓋。
> > 
> > 
> > 
> > ## B. Changelog（變更清單）
> > 
> > - 變更日期：2026-01-06（Asia/Taipei）
> > - 變更性質：Final QA（必要融合更新收斂；去混讀；索引口徑一致化）
> > 
> > | 變更ID | 類型 | 影響範圍 | 說明 |
> > |---|---|---|---|
> > | DI-20260106-01 | FIX | §5 Authoritative Index | 逐列對齊「現行覆蓋輸出」檔名（補齊 `__覆蓋輸出.md`），修正既有檔名殘缺、前綴遺失（如 VERSION_AUDIT / DEPLOY_OPS）、以及與實際專案檔案不一致之風險。 |
> > | DI-20260106-02 | REFACTOR | 正文/非正文邊界 | 將原「工程附錄（Engineering Annex｜不屬正文）」自正文區移入稽核承接（§D.2），避免正文與追溯附錄混排造成裁決混讀。 |
> > | DI-20260106-03 | DOC | 目錄（TOC） | 移除正文目錄中 E1/E2 工程附錄索引項，改由 §D.2 統一承接與宣告其非正文屬性。 |
> > | DI-20260106-04 | AUDIT | §C 指紋清單 | 重新生成指紋清單格式：本文件採 CONTENT_SHA256（不含 §C 區塊）以避免自我指紋遞迴；其餘文件採檔案位元組 SHA-256。 |
> > 
> > 
> > 
> > ## C. Hash Manifest（指紋清單）
...
> > - 雜湊算法：SHA-256
> > - 編碼：UTF-8（以檔案原始位元組計算）
> > - 本文件（DOCUMENT_INDEX）採 **CONTENT_SHA256（不含 §C 指紋清單區塊）**：  
> >   目的為避免「指紋包含自身指紋」造成遞迴不一致；裁決與驗證以本規則為準。
> > 
> > | doc_key | 檔名（現行覆蓋輸出） | SHA-256 |
> > |---|---|---|
> > | AI_GOV | TAITS_AI_行為與決策治理最終規則全集__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106.md | 49fbfd3b2f0d39a675b295ddf6a5552fe362befb2b57c3a5a110752bdfc15bc3 |
> > | DOCUMENT_INDEX | （本文件）CONTENT_SHA256（不含 §C 指紋清單區塊） | 27aaff1009ddf459111cc8f38b6fd9452a2dd94a9cbf05a3540538f1503db209 |
> > | MASTER_ARCH | TAITS_母體總憲法與核心鐵律（MASTER_ARCH）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106.md | 1846f8e3f5d4d901acafda884737481828efbee99f6c161ed86f01b2447d59b0 |
> > | MASTER_CANON | TAITS_完整總架構×總流程×全資訊體系（MASTER_CANON）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106.md | ac544f9a26563d2a2d843aea37af81ea0e70727a260f1419d2320fc268bd134f |
> > | RISK_COMPLIANCE | TAITS_風險控管與合規最高否決權（RISK_COMPLIANCE）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106.md | a3aa8c294ffe0a7f2c592ae49056809c79047599b13cbb7633e68988ec44d40d |
> > | EXECUTION_CONTROL | TAITS_交易執行與控制規範（EXECUTION_CONTROL）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106.md | 96aac321ed9419a615f0476aa0136e892e58dc21de17e462a4b66d9dfdd4151d |
> > | GOVERNANCE_STATE | TAITS_GOVERNANCE_STATE__FREEZE_v1.0__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106.md | 3230a5c4b267e37736dd7f8901e1a0bd87b6ab63e2640b8a788df2f525c41dda |
> > | FULL_ARCH | TAITS_全系統架構總覽（FULL_ARCH）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106.md | 1778f6d7b1c080269d89ddf8528f6308b7f4a831b17a00aca00735a65822463e |
> > | ARCH_FLOW | TAITS_系統架構與流程細化說明（ARCH_FLOW）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106.md | c033bfd3d1d9483cae01bbbc9722ef7a36cad1eb612ab28b16abfdf2b6d63700 |
> > | GOVERNANCE_GATE_SPEC | TAITS_治理閘門與裁決規範（GOVERNANCE_GATE_SPEC）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106.md | 81dcd32168ed6a2972507611d7f89917cdf5ef68d7a0fa7b22666fbd4ac377f3 |
> > | VERSION_AUDIT | TAITS_版本控管、稽核與可追溯治理規範（VERSION_AUDIT）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106.md | 4e492dfe55c610cfe50c94ba56385d7afeff45abc116f2a79823150990a78bdf |
> > | DATA_SOURCES | TAITS_資料來源全集（DATA_SOURCES）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106.md | 636ef3f63d8542a132c2fe8d33f890d0ffb372d7fe0197794563af29f0f09548 |
> > | TWSE_RULES | TAITS_TWSE交易規則參考彙編（TWSE_RULES）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106.md | 8488c8446fa9040a3ff5015b36f60e90b70915110c3ca971fb00401ac55718a3 |
> > | STRATEGY_UNIVERSE | TAITS_策略宇宙全集（STRATEGY_UNIVERSE）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106.md | 5c08953d2f2262d422cad4b60b8a0e27f5780bd691db3250530d184dd5d122e1 |
> > | STRATEGY_FEATURE_INDEX | TAITS_策略特徵與因子索引（STRATEGY_FEATURE_INDEX）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106.md | d175fc04ddad7d96d9f0645d18b2adcb51a7924c59f4dae2bcec5c2548e0ad8a |
> > | UI_SPEC | TAITS_使用者介面與人機決策規範（UI_SPEC）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106.md | 1c114fc703b13cb2ade0027018f616eda5a6a95d4b7b3b9bed40998299df924b |
> > | DEPLOY_OPS | TAITS_部署、營運與日常運作規範（DEPLOY_OPS）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106.md | 2e84589a594d5cfc218b54d40765f2f854b4f7c98450da566904f47b3e9b1340 |
> > | LOCAL_ENV | TAITS_本地執行與運算環境規範（LOCAL_ENV）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106.md | 6fd04f9db05b1efbc2d4d608fa133418ca45350a382fd83235998e5b0c435cb9 |
> > | BEGINNER_GUIDE | TAITS_新手教學與操作引導總則（BEGINNER_GUIDE）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106.md | 55954d3e544942f9997e4c9d0374e7ffbac180514bb5fa4118f480d4a32cae7e |
> > | README | README__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106.md | 5d4669c1ad49a80a330205a28798061ae6da37b505f7dba2b69eacba7941a8b2 |
> > | PROJECT_PROMPT | TAITS_PROJECT_PROMPT__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106.md | a9b0ccfe60c81e324975e6987272366b88041596c7188390cb9d49b9114371ca |
> > 
> > 
> > 
> > ## D. Audit Hand-off（裁決承接）
> > 
> > - 裁決承接序位：DOCUMENT_INDEX → MASTER_ARCH → AI_GOV
> > - 本次變更性質：Final QA 收斂（索引一致化／去混讀／表格修復／章節去重）
> > - 風險聲明：本次更新僅針對索引與文本結構一致化；未變更任何其他治理文件之正文條文。若後續對其他文件執行 Final QA 覆蓋更新，必須以 VERSION_AUDIT 落帳並更新本檔之 Hash Manifest。
> > - 人類確認要求：人類最高決策者核准覆蓋後，本文件即成為 2026-01-06 基線下之唯一有效索引。
> > 
> > ### D.2 工程附錄（Engineering Annex｜非正文）
> > 
> > > 本段落為非正文之工程附錄／歷史工件解析與映射表，僅供稽核與工程追溯使用；不得用於治理裁決。
> > 
...
> >       fix_id: "VA-METADATA_FIX-20251228-0036"
> >     - doc_key: "GOVERNANCE_STATE_FREEZE_V1"
> >       latest_artifact: "TAITS_GOVERNANCE_STATE__FREEZE_v1.0__260104__單一正確正文版__覆蓋版.md"
> >       fix_id: "VA-METADATA_FIX-20251228-0036"
> >     - doc_key: "LOCAL_ENV"
> >       latest_artifact: "TAITS_本地執行與運算環境規範（LOCAL_ENV）__260104__單一正確正文版__覆蓋版__覆蓋輸出.md"
> >       fix_id: "VA-METADATA_FIX-20251228-0036"
> >     - doc_key: "MASTER_ARCH"
> >       latest_artifact: "TAITS_母體總憲法與核心鐵律（MASTER_ARCH）__251219__ADDENDUM_20251227_FINAL.md"
> >       fix_id: "VA-METADATA_FIX-20251228-0036"
...
> >   note: "P1B：補登 稽核檢核 v4 新增之 21 筆 legacy 引用（多為 融合承接/inlineappendix/工程路徑）。"
> >   items:
...
### SNAP-MASTER_ARCH（TAITS_母體總憲法與核心鐵律（MASTER_ARCH）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md）
<a id="snap-master-arch"></a>

- 來源檔名：TAITS_母體總憲法與核心鐵律（MASTER_ARCH）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md
- 來源指紋：SHA-256=8f4456c62dfa03ef1c72b1f5dc4bc7568e5f91f28387061ee17b2815f9f25e04
...
>
> ### 1) 變更清單（Changelog）
> - 修正：將文件內「治理裁決序位」之表述統一收斂為唯一箭頭鏈口徑：DOCUMENT_INDEX → MASTER_ARCH → AI_GOV。
> - 修正：將本檔頂層結構收斂為單一 H1；若原檔存在稽核區塊，已以 Legacy Snapshot 承接於檔尾稽核區塊，避免正文／稽核邊界混讀。
> - 修正：本檔若引用其他治理文件檔名，統一指向現行覆蓋輸出檔名（優先 __CLEAN_260107）。
> - 保留：MASTER_ARCH 全文規範與鐵律條款全量承接，不做摘要縮水；僅做去混讀與引用一致化。
>
>
> ### 2) 指紋清單（Hash Manifest）
> - HASH_METHOD：SHA-256（UTF-8，LF）
> - BODY_SHA256：ddf1e86773d6a9088116c898071a6103ea7c503427b2f2fd99b6e5efe454330f
> - LEGACY_AUDIT_SHA256：d1ea497a068abb5f784f29804ab3257effd05ad2d7301cc0de4f17165e182203
>
> ### 3) 適用範圍（Scope）
...
>
> ### 4) 裁決承接（Audit Hand-off）
> - 本檔為 MASTER_ARCH 現行唯一可引用正文。
> - MASTER_ARCH 之語義高於一般制度級文件；但若與 DOCUMENT_INDEX 發生衝突，仍以裁決序位：DOCUMENT_INDEX → MASTER_ARCH → AI_GOV 為準。
> - 後續任何對「鐵律」與「裁決機制」之調整，必須同步更新 DOCUMENT_INDEX 與 AI_GOV 的承接條款，以維持單一口徑。
>
>
> ### Legacy Audit Snapshot（被本次覆蓋版承接／非正文）
>
...
### SNAP-MASTER_CANON（TAITS_完整總架構×總流程×全資訊體系（MASTER_CANON）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md）
<a id="snap-master-canon"></a>

- 來源檔名：TAITS_完整總架構×總流程×全資訊體系（MASTER_CANON）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md
- 來源指紋：SHA-256=5998e8233638d9d4fb2aa6702845c1c7fba76437a449c8cd263d80838826f2fc
...
>
> ### 1) 變更清單（Changelog）
> - 修正：全文件「治理裁決序位」之表示法統一收斂為唯一箭頭鏈口徑：DOCUMENT_INDEX → MASTER_ARCH → AI_GOV。
> - 修正：若本檔存在「全局定錨（S1）」之 L9/L10/L11 定義，已一致化為 Final QA 強制語義定錨口徑。
> - 修正：本檔若引用其他治理文件檔名，統一指向現行覆蓋輸出檔名（優先 __CLEAN_260107）。
> - 修正：若原檔存在稽核區塊，已以 Legacy Snapshot 承接於檔尾稽核區塊，避免正文／稽核邊界混讀。
> - 保留：MASTER_CANON 內容全量承接，不做摘要縮水；僅做去混讀與引用一致化。
>
>
> ### 2) 指紋清單（Hash Manifest）
> - HASH_METHOD：SHA-256（UTF-8，LF）
> - BODY_SHA256：83edeef50eaad1e7e87ae9c6e122e5973240651e20b7c9e73d1d73571d3818cb
> - LEGACY_AUDIT_SHA256：1a137480d50d7542e88bf95dd2adf74c994a90185aa9c0034e9536411635e2a2
>
> ### 3) 適用範圍（Scope）
> 本次覆蓋版修正範圍僅限於 doc_key=MASTER_CANON：
> - 治理裁決序位表示法一致化（箭頭鏈口徑）
> - 全局定錨（S1）之 L9/L10/L11 定義一致化（若該段存在）
> - 正文／稽核邊界去混讀（檔尾稽核區塊固定化；既有稽核內容以 Legacy Snapshot 承接）
> - 引用檔名一致化（僅更新本檔提及之檔名字串；不修改其他 doc_key 正文內容）
...
>
> ### 4) 裁決承接（Audit Hand-off）
> - 本檔為 MASTER_CANON 現行唯一可引用正文。
> - MASTER_CANON 作為 Canonical Flow（L1–L11）與全資訊體系之總定錨文件；後續若任一層語義定錨調整，必須同步更新：DOCUMENT_INDEX、MASTER_ARCH、AI_GOV 與相關制度文件，以維持單一口徑。
> - 若與其他治理文件存在衝突，裁決序位固定為：DOCUMENT_INDEX → MASTER_ARCH → AI_GOV。
>
>
> ### Legacy Audit Snapshot（被本次覆蓋版承接／非正文）
...
> > 
> > ## A. Scope（適用範圍）
> > - scope_doc_key: MASTER_CANON
> > - scope_files_output: TAITS_完整總架構×總流程×全資訊體系（MASTER_CANON）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106.md
> > - scope_files_source: TAITS_完整總架構×總流程×全資訊體系（MASTER_CANON）__260104__單一正確正文版__覆蓋輸出.md
> > - scope_mode: FILE UPDATE MODE（融合更新／整合重排版／語義定錨一致化／Final QA）
> > - version_date: 2026-01-06（Asia/Taipei）
> > 
> > ## B. Changelog（變更清單）
> > 1) **裁決序位口徑一致化**：將本檔表頭之裁決序位明確收斂為 `DOCUMENT_INDEX → MASTER_ARCH → AI_GOV（最終裁決序位）`，避免將本檔誤讀為更高序位裁決來源。  
> > 2) **去混讀修正（正文）**：移除正文末端殘留之舊版標記（`Final Integrated Edition v2025-12-19`），避免被誤判為正文裁決依據。  
> > 3) **非 Index 文件之引用權限修正**：將「未入 Index 文件可作裁決」更正為「僅可作工程/討論參考、不得成為裁決依據」，以符合 `DOCUMENT_INDEX` 之 Authoritative Index 定義。  
> > 4) **審計密度語義精確化**：補強「模式降級」之邊界，明確不得刪除關鍵裁決/風控留痕，以保持可追溯性。  
> > 5) **稽核留痕承接一致化**：維持單一稽核區塊承接（Scope/Changelog/Hash/Audit Hand-off），正文不混入留痕語句。
> > 
> > ## C. Hash Manifest（指紋清單）
> > - hash_alg: sha256
> > - scope: BODY_ONLY（不含本稽核區塊）
> > |15789b2a0906a3461eec23912d89551ab40cf7d161e380030041391c90db3e
> > 
> > ## D. Audit Hand-off（裁決承接）
> > - change_id: MC-FIX-260106-0001
> > - authority_basis: HFI（人類最高決策者明確命令｜scope=MASTER_CANON｜Final QA 去混讀/一致化）
> > - governance_order_applied: DOCUMENT_INDEX → MASTER_ARCH → AI_GOV
> > - downstream_notes:
> >   - 下游文件（FULL_ARCH／ARCH_FLOW／GOVERNANCE_GATE_SPEC／EXECUTION_CONTROL 等）若仍存在 L9=Gate 或 L11=Execution 等圖表/節點語義殘留，應以本檔 L9/L10/L11 定錨段落為準並在各檔 Final QA 時同步收斂。


---

### SNAP-FULL_ARCH（TAITS_全系統架構總覽（FULL_ARCH）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md）
<a id="snap-full-arch"></a>

- 來源檔名：TAITS_全系統架構總覽（FULL_ARCH）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md
- 來源指紋：SHA-256=9670cf9ea9a405540377a92204bd3d545b4140a56d123f13158d0daf1e679243
...
>
> ### 1) 變更清單（Changelog）
> - 修正：全文中「治理裁決序位」之表示法統一收斂為唯一箭頭鏈口徑：DOCUMENT_INDEX → MASTER_ARCH → AI_GOV。
> - 保留：原 FULL_ARCH 內容全量承接，不做摘要縮水；僅進行表示法一致化與檔首 metadata 標準化。
> - 保留：若原有稽核內容，已以 Legacy Snapshot 方式承接於本檔稽核區塊。
>
>
> ### 2) 指紋清單（Hash Manifest）
> - HASH_METHOD：SHA-256（UTF-8，LF）
> - BODY_SHA256：4232c9bcbe23aae571c46a5d2f628a30561da0472e481b5988bcad172d94cc45
> - LEGACY_AUDIT_SHA256：22f5b6210b4e6cfa916d62ebc83f5747dbdebb980358b9b0f5aa22780df70889
>
> ### 3) 適用範圍（Scope）
> 本次覆蓋版修正範圍僅限於 doc_key=FULL_ARCH：
> - 治理裁決序位表示法一致化（箭頭鏈口徑）
> - 檔首 metadata 標準化（doc_key／基線／覆蓋輸出／去混讀狀態）
> - 不改寫其他章節之制度語義；不新增未授權內容
>
>
> ### 4) 裁決承接（Audit Hand-off）
> - 本檔為 FULL_ARCH 現行唯一可引用正文。
> - 後續若任何文件表述裁決序位，不得使用並列表達（如「／」或「並列 A+/A」）造成二義性；一律使用箭頭鏈口徑。
> - 若與其他治理文件存在衝突，裁決序位固定為：DOCUMENT_INDEX → MASTER_ARCH → AI_GOV。
>
>
> ### Legacy Audit Snapshot（被本次覆蓋版承接／非正文）
...
> > - scope_files_output: TAITS_全系統架構總覽（FULL_ARCH）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106.md
> > - scope_files_source: TAITS_全系統架構總覽（FULL_ARCH）__260104__單一正確正文版__覆蓋輸出.md
> > - scope_mode: FILE UPDATE MODE（融合更新／整合重排版／語義定錨一致化／Final QA）
> > - version_date: 2026-01-06（Asia/Taipei）
> > - anchors_enforced:
...
> > 
> > ## B. Changelog（變更清單）
> > - change_id: FA-FUSION-260104-0010
> > - change_type: 融合更新／整合重排版／語義定錨一致化
> > - summary:
> >   1. 移除重複之「全局定錨（S1）」與「文件定位」段落，保留並合併為單一口徑（避免新舊混讀）。
> >   2. 重排章節順序：先呈現完整 S1（含 L9/L10/L11 與 HFI 定錨），再呈現 FULL_ARCH 文件定位，後續正文維持最大完備。
> >   3. 檔名統一為「單一正確正文版」覆蓋稿，並維持 doc_key／治理等級／裁決序位與 DOCUMENT_INDEX 一致。
> > - notes:
> >   - 以上屬「重排與去重」；正文內容未摘要縮水，僅移除重複模板段落。
> > 
> > - change_id: FA-FINALQA-260106-0001
> > - change_type: Final QA／必要融合更新收斂（去混讀／版本基線一致化）
> > - summary:
> >   1. 版本日期基線統一為 2026-01-06（含稽核 Scope）。
> >   2. 修正誤置之「稽核區塊」：治理補強（G0、G1–G4）回歸正文；稽核區塊僅保留留痕（Scope／Changelog／Hash Manifest／Audit Hand-off）。
> >   3. 正文移除舊版分段標記（v2025-12-19 Part 2 完），改由稽核留痕承接以避免混讀。
> >   4. 收斂正文用語：移除「補丁」字樣以符合去混讀口徑（語義不變）。
> > - notes:
> >   - legacy_marker_moved_to_audit: （FULL_ARCH｜最大完備版 v2025-12-19 · Part 2 完）
> >   - 保留最大完備：未刪減制度內容；僅移位/修正章節邊界與稽核承接。
> > 
> > ### B0. 歷史變更摘錄（原格式保留）
> > - 修正：模組域×L1–L11 對位表中 L9 由「Governance Gate」定錨為「投資報告（Investment Report）」；並明確治理閘門為 non-layer。
> > - 修正：5.1 與 9.2 Mermaid code block fence 錯誤，改為可解析之單一 mermaid 區塊。
> > - 修正：5.1 與 9.2 流程圖移除「L9=Governance Gate」「L11=Execution」語義；L9=Investment Report、L10=Human Decision、Execution Control 為模組、L11=Audit Replay（非下單）。
> > - 修正：4.2 文句將「L11 BLOCK / Execution」改為「Execution Control BLOCK（L11 僅承接回放留痕）」。
> > - 修正：8.8 契約章名與 `GovernanceChecked` 定位，避免將治理閘門誤當 Canonical Layer。
> > - 修正：9.1 Trace Manifest 之 L9/L11 欄位描述，保留相容別名但防止層級混讀。
> > - 收斂：將含舊版標記與引用一致化說明之「治理補強」段落移入檔尾稽核區塊，以符合去混讀要求（正文不殘留補丁式語句）。
> > - 更新：Hash Manifest 以 BODY_ONLY 重新計算並同步。
> > 
> > ## C. Hash Manifest（指紋清單）
> > - hash_alg: sha256
> > - hash_scope: BODY_ONLY（不含本稽核區塊）
> > - hash_value_sha256: 72f57bc2fe4723991e90cf745d7dff3e86e87f9821cac1f85f2b6ff06526858c
> > 
> > ## D. Audit Hand-off（裁決承接）
> > - authority_basis: HFI（人類最高決策者明確命令｜scope=FULL_ARCH｜Final QA＋必要融合更新收斂）
> > - downstream_actions_required:
> >   1. DOCUMENT_INDEX 中 `doc_key=FULL_ARCH` 之 canonical_filename / physical_filename 映射應指向本次覆蓋輸出檔名（避免載入舊版混讀）。
> >   2. ARCH_FLOW / GOVERNANCE_GATE_SPEC / STRATEGY_UNIVERSE 之流程圖若仍以 L9=Governance Gate 或 L11=Execution 呈現，需依本檔定錨同步收斂（L9=投資報告層；L11=稽核回放層；治理閘門為 non-layer）。
> >   3. 任何引用 `GovernanceChecked` 事件者，需以「治理閘門產物（non-layer）」口徑解讀，不得將其視為 L9 層級本體。
> > - acceptance_criteria:
> >   - 無摘要縮水：未被新正文明確取代之內容不得減少；若移位（正文→稽核）需保留全文以避免資訊遺失。
> >   - 無新舊混讀：正文不得殘留 Addendum/Appendix/Freeze 等補丁式語句或舊版標記；留痕僅存在於稽核區塊。
> >   - L9/L10/L11 定錨一致：L9=投資報告層；L10=唯一交易授權入口；L11=全層稽核回放（非下單層）。


---

### SNAP-ARCH_FLOW（TAITS_系統架構與流程細化說明（ARCH_FLOW）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md）
<a id="snap-arch-flow"></a>

- 來源檔名：TAITS_系統架構與流程細化說明（ARCH_FLOW）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md
- 來源指紋：SHA-256=e425aa27efa5e3017fe1cf492736c0894e1a286d66b7453143b82eb8dff948ce
...
> - 保留：ARCH_FLOW 全文規範與流程細化條款全量承接，不做摘要縮水；僅做去混讀與引用一致化。
>
>
> ### 2) 指紋清單（Hash Manifest）
> - HASH_METHOD：SHA-256（UTF-8，LF）
> - BODY_SHA256：4a3062e6c66bfbdf51f8e3082d2167f50a2bf99cedb8d127198a65714b248de7
> - LEGACY_AUDIT_SHA256：b16a1049a40d192eb7ce225f425dcdac4087f3263bd1f9b625e387166dba7a5b
>
> ### 3) 適用範圍（Scope）
> 本次覆蓋版修正範圍僅限於 doc_key=ARCH_FLOW：
> - 治理裁決序位表示法一致化（箭頭鏈口徑）
> - 正文／稽核邊界去混讀（檔尾稽核區塊固定化；既有稽核內容以 Legacy Snapshot 承接）
> - 引用檔名一致化（僅更新本檔提及之檔名字串；不修改其他 doc_key 正文內容）
>
>
> ### 4) 裁決承接（Audit Hand-off）
> - 本檔為 ARCH_FLOW 現行唯一可引用正文。
> - ARCH_FLOW 為流程細化文件；不得覆寫 MASTER_CANON（Canonical Flow 定錨）與 MASTER_ARCH（鐵律與裁決機制）。
> - 若與其他治理文件存在衝突，裁決序位固定為：DOCUMENT_INDEX → MASTER_ARCH → AI_GOV。
>
>
> ### Legacy Audit Snapshot（被本次覆蓋版承接／非正文）
...
> > - scope_files_output: TAITS_系統架構與流程細化說明（ARCH_FLOW）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106.md
> > - scope_files_source: TAITS_系統架構與流程細化說明（ARCH_FLOW）__260104__單一正確正文版__覆蓋輸出.md
> > - scope_mode: FILE UPDATE MODE（融合更新／整合重排版／語義定錨一致化／Final QA）
> > - version_date: 2026-01-06（Asia/Taipei）
> > 
> > ## B. Changelog（變更清單）
> > 1) **Final QA 基線一致化（260106）**：版本日期統一為 2026-01-06、Scope 檔名映射對齊覆蓋輸出、Hash Manifest 重新計算。  
> > 2) **語義定錨一致化（L9/L10/L11）**：移除同檔內將 L9 描述為「Governance Gate」之殘留，統一為 `L9＝投資報告層（Investment Report）`；同時將 L11 之定位統一為 `全層工程稽核回放（Audit Replay）`（L11 非下單層）；並明確 `Execution Control（受控執行）` 為模組（非 Canonical Layer），僅可在 L10 HumanApprove 授權後啟動。  
> > 3) **流程圖/狀態矩陣對齊**：將 State Transition Matrix 之 L9/L10/L11 狀態命名收斂為 `ReportReady/ReportInvalid`、`HumanApprove/HumanReject`、`ReplayReady/AuditFail`；同步修正流程圖節點與箭頭標示，避免 L9/L11 被誤讀為治理閘門或送單層。  
> > 4) **去混讀維持**：正文維持「去混讀」要求（補丁式語句不得混入正文）；留痕僅存在於本檔尾稽核區塊，不參與正文裁決。  
> > 
> > ## C. Hash Manifest（指紋清單）
> > - hash_alg: sha256
> > - manifests:
> >   - name: BODY_ONLY
> >     scope: BODY_ONLY（不含本稽核區塊）
> >     hash_value_sha256: 6c71630fcbcac50f6ce2a2978b10fd9dc9743342530a1d7ee79d5557498c0a9f
> >   - name: FULL_EXCLUDING_HASH_LINE
> >     scope: FULL（含稽核區塊；但不含本段中之 hash_value_sha256 行，以避免自指）
> >     hash_value_sha256: 7fce75c06ccd3c1d59fc24b192a6ad4477089690e526c4fd5b64b25309c6af34
> > 
> > ## D. Audit Hand-off（裁決承接）
> > - change_id: AF-FIX-260106-ARCH_FLOW-FINALQA-0002
> > - authority_basis: HFI（人類最高決策者明確命令｜scope=ARCH_FLOW｜Final QA 去混讀/一致化）
> > - governance_order_applied: DOCUMENT_INDEX → MASTER_ARCH → AI_GOV
> > - downstream_notes:
> >   - DOCUMENT_INDEX（__260106）請確認 Authoritative Index 中 ARCH_FLOW 的檔名映射指向本檔（__260106__...__覆蓋輸出__FINALQA_260106.md），避免載入集合出現多份 ARCH_FLOW。


---

### SNAP-RISK_COMPLIANCE（TAITS_風險控管與合規最高否決權（RISK_COMPLIANCE）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md）
<a id="snap-risk-compliance"></a>

- 來源檔名：TAITS_風險控管與合規最高否決權（RISK_COMPLIANCE）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md
- 來源指紋：SHA-256=de49801b32f8486a345e9a9dd49b65a7d31cac33f5e733cbda388a5cb6ac765a
...
> - 修正：本檔若引用其他治理文件檔名，統一指向現行覆蓋輸出檔名（優先 __CLEAN_260107）。
> - 修正：若原檔存在稽核區塊或補丁式標記，已以 Legacy Snapshot 承接於檔尾稽核區塊，避免正文／稽核邊界混讀。
> - 保留：RISK_COMPLIANCE 全文規範與否決權條款全量承接，不做摘要縮水；僅做去混讀與引用一致化。
>
>
> ### 2) 指紋清單（Hash Manifest）
> - HASH_METHOD：SHA-256（UTF-8，LF）
> - BODY_SHA256：b6e040ed3c4df0267dde7ec5a0fa835c436889743c88aa51b6f208653c0fbf07
> - LEGACY_AUDIT_SHA256：26bd2dccd9e3c6c4430e02a6ea66eba7a431ad9a14e69d6a70750fa39cef1861
>
> ### 3) 適用範圍（Scope）
> 本次覆蓋版修正範圍僅限於 doc_key=RISK_COMPLIANCE：
> - 治理裁決序位表示法一致化（箭頭鏈口徑）
> - 全局定錨（S1）之 L9/L10/L11 定義一致化（若該段存在）
> - 正文／稽核邊界去混讀（檔尾稽核區塊固定化；既有稽核內容以 Legacy Snapshot 承接）
> - 引用檔名一致化（僅更新本檔提及之檔名字串；不修改其他 doc_key 正文內容）
...
>
> ### 4) 裁決承接（Audit Hand-off）
> - 本檔為 RISK_COMPLIANCE 現行唯一可引用正文。
> - RISK/COMPLIANCE 擁有最高否決權；但其裁決序位口徑與衝突裁決仍須依：DOCUMENT_INDEX → MASTER_ARCH → AI_GOV。
> - 後續若調整否決權條款，必須同步更新 MASTER_CANON（流程定錨）與 GOVERNANCE_GATE_SPEC（閘門裁決規範）之承接語句，以維持單一口徑。
>
>
> ### Legacy Audit Snapshot（被本次覆蓋版承接／非正文）
>
...
> > 
> > ## A. Scope（適用範圍）
> > - scope_doc_key: RISK_COMPLIANCE
> > - scope_files_output: TAITS_風險控管與合規最高否決權（RISK_COMPLIANCE）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106.md
> > - scope_files_source: TAITS_風險控管與合規最高否決權（RISK_COMPLIANCE）__260104__單一正確正文版__覆蓋版__覆蓋輸出.md
> > - scope_mode: FILE UPDATE MODE（去混讀／留痕分離／Final QA）
> > - version_date: 2026-01-06（Asia/Taipei）
> > 
> > ## B. Changelog（變更清單）
> > 1) **語義定錨一致化（L11）**：移除任何將 L11 誤指為執行層/送單層之敘述；統一為「L11＝全層工程稽核回放層，非批准亦非下單層」。
> > 2) **交接契約更名**：將 `L7→L11（Execution Control）` 等表述，收斂為 `L7→交易執行控制（Execution Control）`，並明確其受 `EXECUTION_CONTROL` 規範且僅能在 L10 人類裁決後進入。
> > 3) **治理等級定錨**：保留檔首治理等級為 **A（母體／憲法級）**，以符合「最高否決權」治理定位與裁決序位。
> > 4) **留痕分離**：維持 Scope/Changelog/Hash/Audit Hand-off 置於檔尾稽核區塊，正文不混入留痕。
> > 5) **版本一致化**：版本日期更新為 2026-01-06（Asia/Taipei）。
> > 6) **Final QA 承接**：更新 Scope 檔名映射為本次覆蓋輸出，並刷新 Hash Manifest 以確保可追溯性。
> > ## C. Hash Manifest（指紋清單）
> > - hash_alg: sha256
> > - scope_body: BODY_ONLY（不含本稽核區塊）
> > - hash_body_sha256: af676dd280f87bab0bf1d7821155ca657c65aafcb367ecc6b503ca5f2830d48a
> > - scope_full: FULL_FILE_EXCLUDING(hash_full_line)（含稽核區塊，但不含下列 `hash_full_sha256` 這一行）
> > - hash_full_sha256: f24b2540349de0819323392bfe03732c37e4fd79412c1e684f21e361ed3772b0
> > ## D. Audit Hand-off（裁決承接）
> > - change_id: RC-FIX-260106-0001
> > - authority_basis: HFI（人類最高決策者明確命令｜scope=RISK_COMPLIANCE｜Final QA：L11 定錨一致化/交接契約更名/留痕分離/去混讀）
> > - governance_order_applied: DOCUMENT_INDEX → MASTER_ARCH → AI_GOV
> > - notes:
> >   - 建議 ACTIVE 集合僅保留本覆蓋版；原檔 `TAITS_風險控管與合規最高否決權（RISK_COMPLIANCE）__260104__單一正確正文版__覆蓋版__覆蓋輸出.md` 封存以避免混讀。


---

### SNAP-GOVERNANCE_GATE_SPEC（TAITS_治理閘門與裁決規範（GOVERNANCE_GATE_SPEC）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md）
<a id="snap-governance-gate-spec"></a>

- 來源檔名：TAITS_治理閘門與裁決規範（GOVERNANCE_GATE_SPEC）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md
- 來源指紋：SHA-256=bf9b0cf310150262a058163a593f1854d4b921069a28337f773536e7350e50d7
...
### SNAP-EXECUTION_CONTROL（TAITS_交易執行與控制規範（EXECUTION_CONTROL）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md）
<a id="snap-execution-control"></a>

- 來源檔名：TAITS_交易執行與控制規範（EXECUTION_CONTROL）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md
- 來源指紋：SHA-256=17ba6a170d735351e127e0ca076b8c34bc5a2122269dc5169970d1ed2f934e91
...
> - 修正：本檔若引用其他治理文件檔名，統一指向現行覆蓋輸出檔名（優先 __CLEAN_260107）。
> - 修正：若原檔存在稽核區塊或補丁式標記，已以 Legacy Snapshot 承接於檔尾稽核區塊，避免正文／稽核邊界混讀。
> - 保留：EXECUTION_CONTROL 全文條款全量承接，不做摘要縮水；僅做去混讀與引用一致化。
>
>
> ### 2) 指紋清單（Hash Manifest）
> - HASH_METHOD：SHA-256（UTF-8，LF）
> - BODY_SHA256：21a930dc417444946fbed9cfef0ae02414e71cacf09b9fe3e232b5e26f46bc46
> - LEGACY_AUDIT_SHA256：b3a546a22a8adef64062caf544c9efcc361ca84b8b1d17cf9903224156c5f644
>
> ### 3) 適用範圍（Scope）
> 本次覆蓋版修正範圍僅限於 doc_key=EXECUTION_CONTROL：
> - 治理裁決序位表示法一致化（箭頭鏈口徑）
> - 正文／稽核邊界去混讀（檔尾稽核區塊固定化；既有稽核內容以 Legacy Snapshot 承接）
> - 引用檔名一致化（僅更新本檔提及之檔名字串；不修改其他 doc_key 正文內容）
>
>
> ### 4) 裁決承接（Audit Hand-off）
> - 本檔為 EXECUTION_CONTROL 現行唯一可引用正文。
> - EXECUTION_CONTROL 僅規範「執行與控制」，不構成交易授權；交易授權唯一入口仍為 L10（人類裁決）。
> - 若與其他治理文件存在衝突，裁決序位固定為：DOCUMENT_INDEX → MASTER_ARCH → AI_GOV。
>
>
> ### Legacy Audit Snapshot（被本次覆蓋版承接／非正文）
...
> > - scope_files_output: TAITS_交易執行與控制規範（EXECUTION_CONTROL）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106.md
> > - scope_files_source: TAITS_交易執行與控制規範（EXECUTION_CONTROL）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__PATCH1.md
> > - scope_mode: FILE UPDATE MODE（去混讀／留痕分離／Final QA）
> > - version_date: 2026-01-06（Asia/Taipei）
> > 
> > ## B. Changelog（變更清單）
> > 
> > 1) **物理檔名對齊（Index 可裁決）**：本次覆蓋輸出之實體檔名收斂為 `...__FINALQA_260106.md`（移除 `__PATCH1` 後綴），以對齊 `doc_key=DOCUMENT_INDEX` 之 Authoritative Index 可引用性（避免 ACTIVE 引用失配風險）。  
> > 2) **去混讀承接（檔名漂移留痕）**：上一版帶 `__PATCH1` 後綴之實體檔僅作歷史載體，不得被引用為治理正文；如需留存，應改置於封存/歷史區並以本稽核區塊承接。  
> > 3) **Scope 映射修正**：將 `scope_files_source` 由歷史舊檔名修正為「上一版覆蓋輸出（__PATCH1）」以符合可追溯性。  
> > 4) **裁決承接一致化**：維持本檔裁決序位聲明與 Final QA MODE 一致（`DOCUMENT_INDEX → MASTER_ARCH → AI_GOV`）並明確標示本區塊非正文。  
> > 5) **指紋不變（正文未動）**：本次更新僅調整稽核區塊之留痕與檔名對齊資訊；正文（不含稽核區塊）未改動，故 `BODY_ONLY` 之 SHA256 指紋值維持不變。
> > 
> > ## C. Hash Manifest（指紋清單）
> > - hash_alg: sha256
> > - scope: BODY_ONLY（不含本稽核區塊）
> > - hash_value_sha256: e6e9fa33800195f3bac9967de3f8e2c3ebcef6b6d01617e89df453389293dfdc
> > 
> > ## D. Audit Hand-off（裁決承接）
> > - change_id: EC-FIX-260106-0003
> > - authority_basis: HFI（人類最高決策者明確命令｜scope=EXECUTION_CONTROL｜Final QA 留痕分離/去混讀｜檔名對齊）
> > - governance_order_applied: DOCUMENT_INDEX → MASTER_ARCH → AI_GOV
> > - notes:
> >   - 為避免混讀：建議以本覆蓋輸出檔作為唯一可引用正文；上一版 `...__FINALQA_260106__PATCH1.md` 應封存並禁止於工程/治理引用鏈中使用。


---

### SNAP-UI_SPEC（TAITS_使用者介面與人機決策規範（UI_SPEC）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md）
<a id="snap-ui-spec"></a>

- 來源檔名：TAITS_使用者介面與人機決策規範（UI_SPEC）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md
- 來源指紋：SHA-256=128be74a467000e6f43b29fa6ba8ba76cee4c1ddf91535214ae77a164f74e0ed
...
> - 修正：本檔若引用其他治理文件檔名，統一指向現行覆蓋輸出檔名（優先 __CLEAN_260107）。
> - 修正：若原檔存在稽核區塊或補丁式標記，已以 Legacy Snapshot 承接於檔尾稽核區塊，避免正文／稽核邊界混讀。
> - 保留：UI_SPEC 全文條款全量承接，不做摘要縮水；僅做去混讀與引用一致化。
>
>
> ### 2) 指紋清單（Hash Manifest）
> - HASH_METHOD：SHA-256（UTF-8，LF）
> - BODY_SHA256：c5c84347655dc935e1b9939170048b04608fbbe17c6395b10ad7d8d2273bd0cd
> - LEGACY_AUDIT_SHA256：7b04fc313a40aee37550a7383f20c4e349a11aa82c5ac5dc874897c31794cf98
>
> ### 3) 適用範圍（Scope）
> 本次覆蓋版修正範圍僅限於 doc_key=UI_SPEC：
> - 治理裁決序位表示法一致化（箭頭鏈口徑）
> - 全局定錨（S1）之 L9/L10/L11 定義一致化（若該段存在）
> - 正文／稽核邊界去混讀（檔尾稽核區塊固定化；既有稽核內容以 Legacy Snapshot 承接）
> - 引用檔名一致化（僅更新本檔提及之檔名字串；不修改其他 doc_key 正文內容）
...
>
> ### 4) 裁決承接（Audit Hand-off）
> - 本檔為 UI_SPEC 現行唯一可引用正文。
> - UI 僅提供呈現、審閱與人機裁決支援；不得繞過 L10（人類裁決）產生交易授權。
> - 若與其他治理文件存在衝突，裁決序位固定為：DOCUMENT_INDEX → MASTER_ARCH → AI_GOV。
>
>
> ### Legacy Audit Snapshot（被本次覆蓋版承接／非正文）
...
> > ## A. Scope（適用範圍）
> > - doc_key: UI_SPEC
> > - file: TAITS_使用者介面與人機決策規範（UI_SPEC）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106.md
> > - baseline_date: 2026-01-06 (Asia/Taipei)
> > - qa_mode: FINAL_QA_MODE（去混讀／語義定錨一致化／最後檢視）
> > - scope: 清理正文混讀風險、統一裁決序位口徑、合併重複稽核段落為檔尾單一稽核區塊、維持正文最大完備（不做摘要縮水）
> > - non_scope: 不變更 UI 規範之制度語義、不新增未授權之交易/策略建議、不進行任何個股/標的分析
> > 
> > ## B. Changelog（變更清單）
> > - Final QA（2026-01-06）：統一版本日期基線、更新 Scope 檔名映射、刷新 Hash Manifest（維持正文制度語義不變）。
> > - 修正檔頭「裁決序位」口徑：統一為 DOCUMENT_INDEX → MASTER_ARCH → AI_GOV（最終裁決序位），並明確本檔不得加入裁決鏈。
> > - 合併並去重稽核四件套（Scope/Changelog/Hash Manifest/Audit Hand-off）為檔尾單一稽核區塊；移除重複的 A–D 區塊以避免混讀。
> > - 更新 Hash Manifest：提供 BODY_ONLY 與 FULL_EXCLUDING(hash_value_sha256) 兩種指紋口徑，支援可驗證交付。
> > 
> > ## C. Hash Manifest（指紋清單）
> > - hash_alg: sha256
> > - BODY_ONLY.scope: 正文（不含本稽核區塊）
> > - BODY_ONLY.hash_value_sha256: 47fe136ddb83fc8f95109c0d66770277ff01feb4b38a3ec4bc189d1b41c3cd59
> > - FULL_EXCLUDING.scope: 全檔（排除本段內 hash_value_sha256 行，以避免自指）
> > - FULL_EXCLUDING.hash_value_sha256: 8c7920b5e779d2e14b5f28714d562e036feb2bd6a1326cc7c70eee3a7c2336ec
> > 
> > ## D. Audit Hand-off（裁決承接）
> > - change_id: UI_SPEC-FINALQA-260106-0001
> > - authority_basis: HFI（人類最高決策者明確命令｜scope=UI_SPEC｜Final QA 去混讀/一致化）
> > - governance_order_applied: DOCUMENT_INDEX → MASTER_ARCH → AI_GOV
> > - downstream_notes:
> >   - 若其他文件仍存在「L9=Governance Gate」或「L11=Execution」之圖表/標題殘留，須依本檔 S1 定錨一致化。
> >   - 若 DOCUMENT_INDEX 映射條目或檔名後綴與本覆蓋輸出不一致，應以同日（2026-01-06）版本進行映射更新，避免新對話混讀。


---

### SNAP-DEPLOY_OPS（TAITS_部署、營運與日常運作規範（DEPLOY_OPS）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md）
<a id="snap-deploy-ops"></a>

- 來源檔名：TAITS_部署、營運與日常運作規範（DEPLOY_OPS）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md
- 來源指紋：SHA-256=ae49252075f660fa798d2f90b73b4cb8cbfad50420d28cd9421ba3cace7ce381
...
>
> ### 1) 變更清單（Changelog）
> - 修正：移除正文內舊版（__251219）文件頂層標題殘留，避免多版本拼接混讀。
> - 修正：移除正文內可能的多重 H1／文件重啟段落，收斂為單一正文入口。
> - 調整：將任何疑似補丁式標記（若存在）轉為正常章節名稱或移入稽核承接（不以補丁語言呈現於正文）。
> - 保留：原正文內容全量承接，不做摘要縮水；若原有稽核內容，已以 Legacy Snapshot 方式保留。
>
>
> ### 2) 指紋清單（Hash Manifest）
> - HASH_METHOD：SHA-256（UTF-8，LF）
> - BODY_SHA256：b6a7c6022cdfc55cc1fbb3e0de3c5ff101fee8ea0a9e2262c1e21c4560fe2898
> - LEGACY_AUDIT_SHA256：7f3a713baf676826369711be5aa5e250a8d3eb29b36a743eb6596bfaa589de7b
>
> ### 3) 適用範圍（Scope）
> 本次覆蓋版修正範圍僅限於 doc_key=DEPLOY_OPS：
> - 正文去混讀收斂（移除舊版 __251219 頂層標題殘留、移除多重 H1／文件重啟型標記）
> - 版面重排（維持語義不縮水；僅將歷史痕跡承接至稽核區塊）
> - 不改寫既有制度語義；不新增任何未授權之新規範
>
>
> ### 4) 裁決承接（Audit Hand-off）
> - 本檔為 DEPLOY_OPS 現行唯一可引用正文。
> - 任何過往版本差異、拼接殘留、或補丁描述，均不得再回寫進正文；僅能於檔尾稽核區塊留痕。
> - 若與其他文件存在衝突，裁決序位固定為：DOCUMENT_INDEX → MASTER_ARCH → AI_GOV。
>
>
> ### Legacy Audit Snapshot（被本次覆蓋版承接／非正文）
>
...
> > - scope_files_output: TAITS_部署、營運與日常運作規範（DEPLOY_OPS）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106.md
> > - scope_files_source: TAITS_部署、營運與日常運作規範（DEPLOY_OPS）__260104__單一正確正文版__覆蓋輸出.md
> > - scope_mode: FILE UPDATE MODE（融合更新／整合重排版／語義定錨一致化／Final QA）
> > - version_date: 2026-01-06（Asia/Taipei）
> > 
> > ## B. Changelog（變更清單）
> > 1) **裁決序位定錨一致化**：將本檔所有裁決序位口徑收斂為 `DOCUMENT_INDEX → MASTER_ARCH → AI_GOV`（最終裁決序位）；VERSION_AUDIT 僅作稽核治理平行參照，不納入裁決鏈。
> > 2) **去混讀修正**：維持正文不含 Addendum/Appendix/Only-Add/Freeze 等補丁式語句；相關歷史承接僅在檔尾稽核區塊留痕。
> > 3) **版本/檔名一致化**：版本日期更新為 2026-01-06（Asia/Taipei）；輸出為可直接覆蓋之 `__覆蓋輸出.md` 版本，避免跨文件引用錯亂。
> > 4) **稽核段落單一化**：維持檔尾單一稽核區塊（Scope／Changelog／Hash Manifest／Audit Hand-off），留痕與正文分離。
> > 5) **稽核欄位格式修正**：修正 Scope 內 `version_date` 時區重複標記；並將 `scope_files_source` 對齊至實際存在之 `__260104__單一正確正文版__覆蓋輸出.md` 來源檔名，避免引用錯檔。
> > 
> > ## C. Hash Manifest（指紋清單）
> > - hash_alg: sha256
> > - scope: BODY_ONLY（不含本稽核區塊）
> > - hash_value_sha256: 55334f74ef8b357a59f847b23c2d160187cc9f8f2ee4d49e1fa31f7d43e3b2c6
> > 
> > ## D. Audit Hand-off（裁決承接）
> > - change_id: DO-FIX-260104-0047
> > - authority_basis: HFI（人類最高決策者明確命令｜scope=DEPLOY_OPS｜Final QA 去混讀/一致化）
> > - governance_order_applied: DOCUMENT_INDEX → MASTER_ARCH → AI_GOV
> > - downstream_notes:
> >   - DOCUMENT_INDEX 若仍指向 `...DEPLOY_OPS）__260104__單一正確正文版__覆蓋輸出.md`，建議改指向本檔 `...__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106.md`，並將原檔封存，以避免載入集合出現兩份 DEPLOY_OPS。


---

### SNAP-LOCAL_ENV（TAITS_本地執行與運算環境規範（LOCAL_ENV）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md）
<a id="snap-local-env"></a>

- 來源檔名：TAITS_本地執行與運算環境規範（LOCAL_ENV）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md
- 來源指紋：SHA-256=0d46c8b2dad98f2540aa3724b278b21921cac9f13569a7bbf7c735af3ff722af
...
> - 修正：本檔若引用其他治理文件檔名，統一指向現行覆蓋輸出檔名（優先 __CLEAN_260107）。
> - 修正：若原檔存在稽核區塊或補丁式標記，已以 Legacy Snapshot 承接於檔尾稽核區塊，避免正文／稽核邊界混讀。
> - 保留：LOCAL_ENV 全文規範與環境/運算條款全量承接，不做摘要縮水；僅做去混讀與引用一致化。
>
>
> ### 2) 指紋清單（Hash Manifest）
> - HASH_METHOD：SHA-256（UTF-8，LF）
> - BODY_SHA256：db16336ee20ee4b0378f522a5a91ca9b63743d9fa47b668f2b1cdc883a89190b
> - LEGACY_AUDIT_SHA256：b544cb991d3adea98985b10fb80aaa11a88f859a9c53048496aee4b2305fa14f
>
> ### 3) 適用範圍（Scope）
> 本次覆蓋版修正範圍僅限於 doc_key=LOCAL_ENV：
> - 治理裁決序位表示法一致化（箭頭鏈口徑）
> - 正文／稽核邊界去混讀（檔尾稽核區塊固定化；既有稽核內容以 Legacy Snapshot 承接）
> - 引用檔名一致化（僅更新本檔提及之檔名字串；不修改其他 doc_key 正文內容）
>
>
> ### 4) 裁決承接（Audit Hand-off）
> - 本檔為 LOCAL_ENV 現行唯一可引用正文。
> - LOCAL_ENV 僅規範本地執行/運算環境；不得改寫治理裁決序位與 Canonical Flow 定錨。
> - 若與其他治理文件存在衝突，裁決序位固定為：DOCUMENT_INDEX → MASTER_ARCH → AI_GOV。
>
>
> ### Legacy Audit Snapshot（被本次覆蓋版承接／非正文）
...
> > - scope_files_output: TAITS_本地執行與運算環境規範（LOCAL_ENV）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106.md
> > - scope_files_source: TAITS_本地執行與運算環境規範（LOCAL_ENV）__260104__單一正確正文版__覆蓋版__覆蓋輸出.md
> > - scope_mode: FILE UPDATE MODE（去混讀／留痕分離／Final QA）
> > - version_date: 2026-01-06（Asia/Taipei）
> > 
> > ## B. Changelog（變更清單）
> > 1) **留痕分離**：若原正文含 Scope/Changelog/Hash/Audit Hand-off（A/B/C/D）段落，已自正文移除並統一置於本檔稽核區塊。  
> > 2) **去混讀修正**：中性化補丁式字樣（Addendum/Appendix/Only-Add/POSTCHECK）為不造成裁決混讀的表述（歷史承接/附錄/累積式更新/稽核檢核）。  
> > 3) **版本一致化**：統一日期為 2026-01-06（Asia/Taipei）（原 2026-01-04）。
> > 
> > ## C. Hash Manifest（指紋清單）
> > - hash_alg: sha256
> > - scope: BODY_ONLY（不含本稽核區塊）
> > - hash_value_sha256: 49ab6aebe5fe7472c37da311e5fd3d59abf555b899213dfc9c1a18386cecfa60
> > 
> > ## D. Audit Hand-off（裁決承接）
> > - change_id: LE-FIX-260106-0001
> > - previous_change_id: LE-FIX-260104-0055
> > - authority_basis: HFI（人類最高決策者明確命令｜scope=LOCAL_ENV｜Final QA 留痕分離/去混讀）
> > - governance_order_applied: DOCUMENT_INDEX → MASTER_ARCH → AI_GOV
> > - notes:
> >   - 建議 ACTIVE 集合僅保留本覆蓋版；原檔 `TAITS_本地執行與運算環境規範（LOCAL_ENV）__260104__單一正確正文版__覆蓋版__覆蓋輸出.md` 封存以避免混讀。
> > 
> > 
> > ## E. Legacy Audit Archive（歷史留痕歸檔｜非當前裁決承接｜僅供追溯）
> > ### Archive A. Scope（適用範圍）
> > - scope_doc_key: LOCAL_ENV
> > - scope_files_modified: TAITS_本地執行與運算環境規範（LOCAL_ENV）__260104.md
> > - scope_mode: FILE UPDATE MODE（融合更新／整合重排版／語義定錨一致化／Final QA）
> > - version_date: 2026-01-06（Asia/Taipei）
> > - predecessor: TAITS_本地執行與運算環境規範（LOCAL_ENV）__260104.md
> > 
> > ### Archive B. Changelog（變更清單）
> > 1) 版本日期與檔名升版：`__260104` → `__260104`；並更新文件 header 中之版本日期為 2026-01-04（Asia/Taipei）。  
> > 2) 子章節編號一致化：修正第 4–13 章之子章節編號偏移（+1），確保「章號－節號」一致，避免同名章節散落造成引用混讀。  
> > 3) 治理狀態用語中性化：將正文中「治理狀態 狀態」改為「治理狀態（以 GOVERNANCE_STATE 為準）」，避免將狀態標籤誤當規則來源。  
> > 4) 新增導覽目錄：新增 Level-2 目錄（僅供導覽），不改變既有條文之權限、邊界、隔離與稽核要求。
> > 
> > ### Archive C. Hash Manifest（指紋清單）
> > - hash_alg: sha256
> > - scope: BODY_ONLY（不含本 Audit Section）
> > - hash_value_sha256: 7af2d9a2e4f2c04ca69f8149f3e9441011824a773f48da0cb4f5dabfbac6977d
> > 
> > ### Archive D. Audit Hand-off（裁決承接）
> > - change_id: LE-FUSION-260104-0001
> > - authority_basis: HFI（人類最高決策者明確命令｜scope=LOCAL_ENV 文件融合更新）
> > - downstream_requirements:
> >   - DOCUMENT_INDEX 必須將 LOCAL_ENV 之 ACTIVE 檔名版本映射對齊 `__260104`（避免新對話載入混讀）。
> >   - 若後續 LOCAL_ENV 與 EXECUTION_CONTROL / RISK_COMPLIANCE / VERSION_AUDIT / DEPLOY_OPS 之表述產生張力，依 `DOCUMENT_INDEX → MASTER_ARCH → AI_GOV` 裁決，並以 VERSION_AUDIT 落帳（CHANGELOG＋HASH_MANIFEST＋Scope＋Audit Hand-off）。


---

### SNAP-VERSION_AUDIT（TAITS_版本控管、稽核與可追溯治理規範（VERSION_AUDIT）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md）
<a id="snap-version-audit"></a>

- 來源檔名：TAITS_版本控管、稽核與可追溯治理規範（VERSION_AUDIT）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md
- 來源指紋：SHA-256=ae67e70cae509914ba806a4fce527ac829cb8784dff5b2045c67a4974be5e972
...
> - 修正：本檔若引用其他治理文件檔名，統一指向現行覆蓋輸出檔名（優先 __CLEAN_260107）。
> - 修正：若原檔存在稽核區塊或補丁式標記，已以 Legacy Snapshot 承接於檔尾稽核區塊，避免正文／稽核邊界混讀。
> - 保留：VERSION_AUDIT 全文規範與稽核/可追溯條款全量承接，不做摘要縮水；僅做去混讀與引用一致化。
>
>
> ### 2) 指紋清單（Hash Manifest）
> - HASH_METHOD：SHA-256（UTF-8，LF）
> - BODY_SHA256：4cf3af1a98cc2731fea1c435952d6bc97ecd42eabb5da6e7b6751c0c3871d2a4
> - LEGACY_AUDIT_SHA256：692b27da5eb70264e2c98b3f75433f5063e3d5b0edea2e61efdb022c73602684
>
> ### 3) 適用範圍（Scope）
> 本次覆蓋版修正範圍僅限於 doc_key=VERSION_AUDIT：
> - 治理裁決序位表示法一致化（箭頭鏈口徑）
> - 正文／稽核邊界去混讀（檔尾稽核區塊固定化；既有稽核內容以 Legacy Snapshot 承接）
> - 引用檔名一致化（僅更新本檔提及之檔名字串；不修改其他 doc_key 正文內容）
>
>
> ### 4) 裁決承接（Audit Hand-off）
> - 本檔為 VERSION_AUDIT 現行唯一可引用正文。
> - 所有「留痕、指紋、版本鎖定」必須以本檔規範為準，並由檔尾稽核區塊承接；正文不得混入補丁/追加語句。
> - 若與其他治理文件存在衝突，裁決序位固定為：DOCUMENT_INDEX → MASTER_ARCH → AI_GOV。
>
>
> ### Legacy Audit Snapshot（被本次覆蓋版承接／非正文）
...
> > - scope_files_output: TAITS_版本控管、稽核與可追溯治理規範（VERSION_AUDIT）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106.md
> > - scope_files_source: TAITS_版本控管、稽核與可追溯治理規範（VERSION_AUDIT）__260104__單一正確正文版__最終覆蓋版__覆蓋輸出.md
> > - scope_mode: FILE UPDATE MODE（去混讀／章節去重／留痕分離／Final QA）
> > - version_date: 2026-01-06（Asia/Taipei）
> > 
> > ## B. Changelog（變更清單）
> > 0) **Final QA 基線一致化（2026-01-06）**：版本日期更新、Scope 檔名映射修正、Hash Manifest 重算（不改寫正文制度條款）。  
...
> > - body_only:
> >   - scope: BODY_ONLY（不含本稽核區塊）
> >   - hash_value_sha256: 18958135af034083dc82d7f3dfac248953110383d7284aac8209735216c91f0a
> > - full_excluding_hash_line:
> >   - scope: FULL_EXCLUDING(hash_value_sha256)（含稽核區塊；但不含實際 hash_value 行，以避免自指）
> >   - hash_value_sha256: adadab0272a399803aa5d9c7faccc3052c17a5e95c72408489768ce5e5c30b31
> > 
> > ## D. Audit Hand-off（裁決承接）
> > - change_id: VA-FINALQA-260106-0001
> > - authority_basis: HFI（人類最高決策者明確命令｜scope=VERSION_AUDIT｜Final QA）
> > - governance_order_applied: DOCUMENT_INDEX → MASTER_ARCH → AI_GOV
> > - notes:
> >   - 本次輸出檔：`TAITS_版本控管、稽核與可追溯治理規範（VERSION_AUDIT）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106.md`（覆蓋用）。
> >   - 建議 ACTIVE 集合僅保留本最終覆蓋版；原檔 `TAITS_版本控管、稽核與可追溯治理規範（VERSION_AUDIT）__260104__單一正確正文版__覆蓋版.md` 封存以避免混讀。


---

### SNAP-DATA_SOURCES（TAITS_資料來源全集（DATA_SOURCES）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md）
<a id="snap-data-sources"></a>

- 來源檔名：TAITS_資料來源全集（DATA_SOURCES）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md
- 來源指紋：SHA-256=af5c2743cb2fdfdde649260455891d6f3ef083468338be4fe693809256f28631

> # TAITS_資料來源全集（DATA_SOURCES）__260106（單一正確正文版）
>
> doc_key：DATA_SOURCES  
> 治理等級：B（治理／制度級｜資料來源全集）  
> 適用範圍：TAITS 全系統（資料來源清單／source_id 規格／授權/合規/風控標註／更新頻率/品質等級／資料落地與稽核）  
> 版本狀態：ACTIVE（單一正確正文版｜最大完備＋累積式更新）  
> 版本日期：2026-01-06（Asia/Taipei）  
> 裁決序位：DOCUMENT_INDEX → MASTER_ARCH → AI_GOV（最終裁決序位；本檔受其約束）
> 平行參照：MASTER_CANON／ARCH_FLOW／RISK_COMPLIANCE／VERSION_AUDIT／TWSE_RULES  
> 變更原則：最大完備＋累積式更新（允許融合更新／覆寫修正／重排版以形成單一正確正文；禁止摘要化縮水；未被新版本明確取代之有效內容一律保留並持續累積；已被新版本明確取代者可自正文移除但必須由稽核留痕承接）
>
> ---
>
...
### SNAP-TWSE_RULES（TAITS_TWSE交易規則參考彙編（TWSE_RULES）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md）
<a id="snap-twse-rules"></a>

- 來源檔名：TAITS_TWSE交易規則參考彙編（TWSE_RULES）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md
- 來源指紋：SHA-256=7261c05430860240c75fd43e05a069b17ce138df7b4a6fc6c32552e84added74
...
>
> ### 1) 變更清單（Changelog）
> - 修正：去除正文內重複章節標題（例：同名「全局定錨｜單一口徑（S1）」與「治理一致化條款」重複出現），收斂為單一正文章節入口。
> - 修正：將「治理一致化條款（正文）（補充）」等同義章節名收斂為同一正文章節名，以避免引用二義性。
> - 保留：所有原文條款內容全量承接，不做摘要縮水；僅移除重複標題行與文件重啟型結構噪音。
> - 保留：若原有稽核內容，已以 Legacy Snapshot 方式承接於本檔稽核區塊。
>
>
> ### 2) 指紋清單（Hash Manifest）
> - HASH_METHOD：SHA-256（UTF-8，LF）
> - BODY_SHA256：ea0c34cbb65a4b18a4cbfae9f146ad7081e5a8a759a0715d9582a699750b96a5
> - LEGACY_AUDIT_SHA256：d00f5024f30f592872f59028bbba6a8fb6282103a5f3d3564bd645d1d1fabd3c
>
> ### 3) 適用範圍（Scope）
> 本次覆蓋版修正範圍僅限於 doc_key=TWSE_RULES：
> - 正文章節結構去重（移除重複章節標題／同義標題重複）
> - 版面重排（維持語義不縮水；不改寫規則條款文字內容）
> - 去混讀收斂（確保正文為單一可引用版本；留痕集中於檔尾稽核區塊）
>
>
> ### 4) 裁決承接（Audit Hand-off）
> - 本檔為 TWSE_RULES 現行唯一可引用正文。
> - 任何過往版本差異、重複章節、或補充描述，不得再以「正文補丁」形式插回正文；僅能於檔尾稽核區塊留痕。
> - 若與其他治理文件存在衝突，裁決序位固定為：DOCUMENT_INDEX → MASTER_ARCH → AI_GOV。
>
>
> ### Legacy Audit Snapshot（被本次覆蓋版承接／非正文）
...
> > 
> > ## A. Scope（適用範圍）
> > - scope_doc_key: TWSE_RULES
> > - scope_files_output: TAITS_TWSE交易規則參考彙編（TWSE_RULES）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106.md
> > - scope_files_source: TAITS_TWSE交易規則參考彙編（TWSE_RULES）__260104__單一正確正文版__覆蓋輸出.md
> > - scope_mode: FILE UPDATE MODE（融合更新／整合重排版／語義定錨一致化／Final QA）
> > - version_date: 2026-01-06（Asia/Taipei）
> > 
> > ## B. Changelog（變更清單）
> > 1) **去混讀修正**：將正文中作為補丁標記的字樣（Addendum/Appendix/Only-Add/Freeze 等）中性化為「融合承接/附錄/累積式更新/治理狀態」等不造成新舊混讀的表述；不刪減任何規則彙編條目。  
> > 2) **版本/檔名一致化**：將正文內殘留的 `__260102` 與舊日期引用統一為 `__260106`／2026-01-06（Asia/Taipei），避免跨文件引用錯亂。  
> > 3) **稽核段落單一化**：以本檔末端單一稽核區塊承接（留痕與正文分離）。
> > 
> > ## C. Hash Manifest（指紋清單）
> > - hash_alg: sha256
> > - hash_scope_primary: BODY_ONLY（不含本稽核區塊）
> > a6f924fa54aa74fd7b026fc29bfe274df19d0915b14779483e53a3eb39ad9a2
> > - hash_scope_secondary: FULL_EXCLUDING_HASH_VALUES（含稽核區塊；將本節內所有 hash 值行置換為 `<HASH>` 後再計算）
> > - hash_full_excluding_hash_values_sha256: c83306373f1a4449a4eeade0d8a62a9b8ff3f472029a0d3407bcadf9749c934c
> > - hashing_rules:
> >   - BODY_ONLY 取「檔頭至 `# 稽核區塊` 前」之全文字元序列。
> >   - FULL_EXCLUDING_HASH_VALUES 取全檔，但將本節內所有 hash 值行統一置換為 `<HASH>`，避免自指。
> > 
> > ## D. Audit Hand-off（裁決承接）
> > - change_id: TR-FIX-260104-0048
> > - authority_basis: HFI（人類最高決策者明確命令｜scope=TWSE_RULES｜Final QA 去混讀/一致化）
> > - governance_order_applied: DOCUMENT_INDEX → MASTER_ARCH → AI_GOV
> > - downstream_notes:
> >   - DOCUMENT_INDEX 若仍指向 `...TWSE_RULES）__260106.md`，建議改指向本檔 `TAITS_TWSE交易規則參考彙編（TWSE_RULES）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106.md`，並將原檔封存，以避免載入集合出現兩份 TWSE_RULES。


---

### SNAP-STRATEGY_UNIVERSE（TAITS_策略宇宙全集（STRATEGY_UNIVERSE）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md）
<a id="snap-strategy-universe"></a>

- 來源檔名：TAITS_策略宇宙全集（STRATEGY_UNIVERSE）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md
- 來源指紋：SHA-256=9017b87401f472fdfbd0e15d2a850e60d7b96bec9f40fbb3485fb8f3ef5d923e

> # TAITS_策略宇宙全集（STRATEGY_UNIVERSE）__260106（單一正確正文版）
>
> doc_key：STRATEGY_UNIVERSE  
> 治理等級：B（治理／制度級｜策略宇宙全集）  
> 適用範圍：TAITS 策略層（策略分類/定義/輸入輸出契約/可用條件/禁用條件；策略本身不等於下單）  
> 版本狀態：ACTIVE（單一正確正文版｜最大完備＋累積式更新）  
> 版本日期：2026-01-06（Asia/Taipei）  
> 裁決序位：DOCUMENT_INDEX → MASTER_ARCH → AI_GOV  
> 平行參照：STRATEGY_FEATURE_INDEX／RISK_COMPLIANCE／GOVERNANCE_GATE_SPEC／EXECUTION_CONTROL／UI_SPEC  
> 變更原則：最大完備＋累積式更新（允許融合更新／覆寫修正／重排版以形成單一正確正文；禁止摘要化縮水；未被新版本明確取代之有效內容一律保留並持續累積；已被新版本明確取代者可自正文移除但必須由稽核留痕承接）
>
> ---
>
...
> # 稽核區塊（Audit Section｜非正文）
>
> > 本區塊為「本次更新」之留痕（Changelog／Hash Manifest／Scope／Audit Hand-off），不構成正文裁決依據；若正文與上位治理規範衝突，最終裁決序位一律以：DOCUMENT_INDEX → MASTER_ARCH → AI_GOV。
>
> ## A. Scope（適用範圍）
> - doc_key：STRATEGY_UNIVERSE
> - version_date（正文基線）：2026-01-06（Asia/Taipei）
> - 本次收斂日期（Final QA）：2026-01-07（Asia/Taipei）
> - 覆蓋輸出：單一正確正文版／最終覆蓋版（去混讀收斂：單一正文起點＋單一檔尾稽核區塊）
> - physical_filename（本次交付檔名）：TAITS_策略宇宙全集（STRATEGY_UNIVERSE）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md
> - canonical_filename（Index 裁決檔名）：TAITS_策略宇宙全集（STRATEGY_UNIVERSE）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106.md
> - 變更類型：Final QA（去混讀／語義定錨一致化／章節重排版）
> - 不在範圍（明確排除）：
>   - 新增策略內容或策略語義
>   - 變更上位治理母法／裁決序位規範
>   - 變更任何交易授權規則（交易仍僅能由 L10 授權；下單控制仍依 EXECUTION_CONTROL）
>
> ## B. Changelog（變更清單）
> 1) **去混讀收斂**：移除正文內多重 H1 與 `__251219` 版本標題嵌入；將原先分段內容整併為單一正文（新增 `§12 策略群明細（最大完備清單）` 承接原分段全文；僅調整標題層級以避免多正文起點）。  
> 2) **身份定錨（Canonical Identity）**：A7／A9 之 `canonical_filename` 更新為 DOCUMENT_INDEX 所指向之 260106 覆蓋版檔名，移除舊 `__251219.md` 指向。  
> 3) **裁決序位口徑一致化**：本檔 metadata 之「裁決序位」收斂為 `DOCUMENT_INDEX → MASTER_ARCH → AI_GOV`；MASTER_CANON 保留為 Canonical Flow 參照，明確標註其非衝突裁決序位。  
> 4) **稽核一致化**：重算並更新本檔與關聯上位文件之 SHA-256 指紋清單。  
>
> ## C. Hash Manifest（指紋清單）
> - hash_algo：SHA-256
> - STRATEGY_UNIVERSE（本檔｜覆蓋版）：b41706611c7a91840f4faa85ce87178798380a23a6e1c8bd68d0d41f5a11ad72
> - DOCUMENT_INDEX：b216cb07557d6bf5807c1cc146cde1be2fa1dfcfb22d15fdd3521a4869545e80
> - MASTER_ARCH：1846f8e3f5d4d901acafda884737481828efbee99f6c161ed86f01b2447d59b0
> - AI_GOV：49fbfd3b2f0d39a675b295ddf6a5552fe362befb2b57c3a5a110752bdfc15bc3
> - MASTER_CANON（流程參照）：ac544f9a26563d2a2d843aea37af81ea0e70727a260f1419d2320fc268bd134f
> - STRATEGY_FEATURE_INDEX（平行參照）：d175fc04ddad7d96d9f0645d18b2adcb51a7924c59f4dae2bcec5c2548e0ad8a
> - RISK_COMPLIANCE（平行參照）：a3aa8c294ffe0a7f2c592ae49056809c79047599b13cbb7633e68988ec44d40d
> - GOVERNANCE_GATE_SPEC（平行參照）：81dcd32168ed6a2972507611d7f89917cdf5ef68d7a0fa7b22666fbd4ac377f3
> - EXECUTION_CONTROL（平行參照）：75b746ecd89e7dd61a2325c7a516294b284a3161f160f749c88c5cfd8da5aa6a
> - UI_SPEC（平行參照）：1c114fc703b13cb2ade0027018f616eda5a6a95d4b7b3b9bed40998299df924b
>
> ## D. Audit Hand-off（裁決承接）
> - 最終裁決序位：DOCUMENT_INDEX → MASTER_ARCH → AI_GOV  
> - 本檔治理定位：策略宇宙全集（策略白名單母表與治理規範）；策略輸出僅可生成「信號／報告」，不得構成下單指令。  
> - 交易授權邊界：唯一交易授權入口為 L10；任何執行控制與下單防線依 EXECUTION_CONTROL；Risk／Compliance 擁有最高否決權。  
> - 後續 Final QA 建議點名（未更新）：STRATEGY_FEATURE_INDEX → DEPLOY_OPS → TWSE_RULES → TAITS_PROJECT_PROMPT → BEGINNER_GUIDE → FULL_ARCH


---

### SNAP-STRATEGY_FEATURE_INDEX（TAITS_策略特徵與因子索引（STRATEGY_FEATURE_INDEX）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md）
<a id="snap-strategy-feature-index"></a>

- 來源檔名：TAITS_策略特徵與因子索引（STRATEGY_FEATURE_INDEX）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md
- 來源指紋：SHA-256=78f5b198319ea7c698c56d9cdefb03a32ba6c362a533d8c457019d5a126cb2e1
...
>
> ### 1) 變更清單（Changelog）
> - 修正：移除正文內重複之文件頂層標題（含舊版 __251219 標題），避免多版本拼接混讀。
> - 修正：將「Block A」等補丁式段名改為正常正文章節名稱（不以補丁語言呈現），並保留原內容。
> - 修正：若存在「Part/分段」型標記，統一收斂為正文章節（保留內容，移除分段檔案痕跡）。
> - 保留：原正文全部資訊承接，不做摘要縮水；若有原稽核內容，已移入本檔「Legacy Audit Snapshot」承接。
>
>
> ### 2) 指紋清單（Hash Manifest）
> - HASH_METHOD：SHA-256（UTF-8，LF）
> - BODY_SHA256：baa6e2d9369ed35443e743ac5e8193d076a19db7a463fd5b9df64c80b7839c0b
> - LEGACY_AUDIT_SHA256：70fb539a3bc0c8f27ba1b48f53e05778b40b7d6fa317ba1cab35407a1c682cf9
>
> ### 3) 適用範圍（Scope）
> 本次覆蓋版修正範圍僅限於 doc_key=STRATEGY_FEATURE_INDEX：
> - 正文去混讀收斂（移除多重 H1／舊版標題殘留／補丁式段名混讀）
> - 版面重排（維持語義不縮水；僅將歷史／補丁痕跡移至稽核區塊承接）
> - 不新增任何未授權之策略內容；僅整理既有段落結構與可讀性
>
>
> ### 4) 裁決承接（Audit Hand-off）
> - 本檔為 STRATEGY_FEATURE_INDEX 現行唯一可引用正文。
> - 任何過往版本差異、拼接殘留、或補丁描述，均不得再回寫進正文；僅能於檔尾稽核區塊留痕。
> - 若與其他文件存在衝突，裁決序位固定為：DOCUMENT_INDEX → MASTER_ARCH → AI_GOV。
>
>
...
> > - scope_files_source: TAITS_策略特徵與因子索引（STRATEGY_FEATURE_INDEX）__260104__單一正確正文版__覆蓋輸出.md
> > - scope_files_output: TAITS_策略特徵與因子索引（STRATEGY_FEATURE_INDEX）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106.md
> > - governance_order_applied: DOCUMENT_INDEX → MASTER_ARCH → AI_GOV
> > 
> > ## B. Changelog（變更清單）
> > 1. 1) **裁決序位定錨**：將檔頭與 S1 定錨段落之裁決序位統一收斂為 `DOCUMENT_INDEX → MASTER_ARCH → AI_GOV`；`MASTER_CANON` 僅保留為平行參照（不得改變裁決序位）。
> > 2. 2) **L9/L10/L11 強制定錨一致化**：修正 `2.1 層級隔離` 中將 L9 誤作 Governance Gate、將 L11 誤作 Execution 的語義；改為 L9=投資報告、L10=人類裁決（唯一交易授權入口）、L11=稽核回放；並將 Governance Gate/Execution Control 明確標示為 non-layer 機制/模組。
> > 3. 3) **正文去混讀**：將正文內之重複檔頭 metadata 與「治理補強」留痕段落移入本檔稽核區塊承接（內容不縮水、僅移位），避免新舊混讀與同檔自撞。
> > 4. 4) **稽核四件套單一化**：以檔尾單一稽核區塊承接 Scope/Changelog/Hash Manifest/Audit Hand-off，確保留痕不混入正文敘述。
> > 5. Final QA 2026-01-06｜基線一致化：更新版本日期、Scope 檔名映射、並重算 Hash Manifest（正文制度條款不改寫）。
> > 
> > 
> > ## C. Hash Manifest（指紋清單）
> > - hash_alg: sha256
> > - BODY_ONLY:
> >   - scope: BODY_ONLY（不含本稽核區塊）
> >   - hash_value_sha256: 5b1ede2dfe43195c09b219a5d6c63ddb602ae1f27059ffdc184510024a4c7849
> > - FULL_EXCLUDING_HASH_VALUE_LINES:
> >   - scope: FULL（含稽核區塊；但排除本段所有 `hash_value_sha256:` 行以避免自指）
> >   - hash_value_sha256: 1f2080aca236816d23302eca0605da8fb04b08493b2ea248e0c1a04d21f34eee
> > 
> > ## D. Audit Hand-off（裁決承接）
> > - change_id: SFI-FINALQA-260104-0001
> > - authority_basis: HFI（人類最高決策者明確命令｜scope=STRATEGY_FEATURE_INDEX｜Final QA 去混讀/定錨一致化）
> > - governance_order_applied: DOCUMENT_INDEX → MASTER_ARCH → AI_GOV
> > - audit_handoff:
> >   - downstream_should_recheck:
> >     - FULL_ARCH（若仍存在 L9/L11 圖表殘留，需與本檔定錨一致）
> >     - ARCH_FLOW（若仍存在 L9/L11 流程殘留，需與本檔定錨一致）
> >     - GOVERNANCE_GATE_SPEC（若仍存在 Gate=Layer 綁定，需以 non-layer 收斂）
> >   - notes:
> >     - 本檔為策略特徵/因子索引與語義邊界規範；不得被策略/Agent 當作交易指令或裁決來源。
> > 
> > ## E. Moved Content（自正文移出以避免混讀｜留痕承接）
> > 
> > ### E.1 重複檔頭Metadata（已自正文移出以避免混讀）
> > 
> > ```
> > doc_key：STRATEGY_FEATURE_INDEX
> > 治理等級：B+（Feature Governance & Semantic Boundary Charter｜全知識自洽最大完備版）
...
> > ```
> > 
> > ### E.2 正文內治理補強段（已移至稽核留痕以避免混讀）
> > 
> > ```
> > ## 治理補強（已整合為正文）
> > 上位裁決：AI_GOV（A+）＋Index Gate（DOCUMENT_INDEX）＋MASTER_ARCH（A）＋MASTER_CANON（A）
> > 口徑對齊：
> > 目的：在不改寫本文件任何既有治理條款與內容的前提下，消解「治理等級：B+」可能被誤讀為新治理層級之歧義；將本文件之治理身份、引用合法性、裁決序列字串全面對齊 DOCUMENT_INDEX；確保 以 GOVERNANCE_STATE 現況為準（若見 治理狀態 字樣，視為歷史標記） 下跨文件引用一致、可稽核、可回放。
> > ---
> > ```
...
### SNAP-GOVERNANCE_STATE（TAITS_GOVERNANCE_STATE__FREEZE_v1.0__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md）
<a id="snap-governance-state"></a>

- 來源檔名：TAITS_GOVERNANCE_STATE__FREEZE_v1.0__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md
- 來源指紋：SHA-256=1ee6547bb3f45a7f3291457962651bc49927cac1a0f3924c81792237802755e9
...
### SNAP-BEGINNER_GUIDE（TAITS_新手教學與操作引導總則（BEGINNER_GUIDE）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md）
<a id="snap-beginner-guide"></a>

- 來源檔名：TAITS_新手教學與操作引導總則（BEGINNER_GUIDE）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md
- 來源指紋：SHA-256=7dd1f25c27cc1031272a8a7b1bfaba84a532ab3b2095a5664bf9cf24d06b1a58
...
>
> ### 1) 變更清單（Changelog）
> - 修正：全局定錨（S1）中 L9/L10/L11 定義收斂為「Final QA 強制語義定錨」口徑。
> - 保留：原新手教學全文承接，不做摘要縮水；僅針對定錨定義做一致化修正。
> - 保留：若原有稽核內容，已以 Legacy Snapshot 方式承接於本檔稽核區塊。
>
>
> ### 2) 指紋清單（Hash Manifest）
> - HASH_METHOD：SHA-256（UTF-8，LF）
> - BODY_SHA256：b7f02253e20773245b0d807b22f9a1fb0a873ea6413f065e51ee381209fb9c66
> - LEGACY_AUDIT_SHA256：049813d0c444143e25cf9676e145ac0e66ea9a8dadb8e13c5627f4431adfd752
>
> ### 3) 適用範圍（Scope）
> 本次覆蓋版修正範圍僅限於 doc_key=BEGINNER_GUIDE：
> - 針對「全局定錨｜單一口徑（S1）」之 L9/L10/L11 定義進行一致化（強制定錨）
> - 不改寫其他章節之治理語義；不新增未授權規範
>
>
> ### 4) 裁決承接（Audit Hand-off）
> - 本檔為 BEGINNER_GUIDE 現行唯一可引用正文。
> - 後續若調整 S1 定錨口徑，必須同步更新所有含 S1 定錨段之文件（至少：TAITS_PROJECT_PROMPT、MASTER_CANON、UI_SPEC 若引用）。
> - 若與其他治理文件存在衝突，裁決序位固定為：DOCUMENT_INDEX → MASTER_ARCH → AI_GOV。
>
>
> ### Legacy Audit Snapshot（被本次覆蓋版承接／非正文）
...
> > # 稽核區塊（Audit Section｜非正文）
> > 
> > > 本區塊為「本次覆蓋輸出」之留痕（Scope／Changelog／Hash Manifest／Audit Hand-off／Archive）。正文不得混入補丁式語句；歷史內容如需保留，必須移入本區塊的 Archive 承接。
> > 
> > ## A. Scope（適用範圍）
> > - scope_doc_key: BEGINNER_GUIDE
> > - scope_files_output: TAITS_新手教學與操作引導總則（BEGINNER_GUIDE）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106.md
> > - scope_files_source: TAITS_新手教學與操作引導總則（BEGINNER_GUIDE）__260104.md
> > - scope_mode: FILE UPDATE MODE（融合更新／整合重排版／語義定錨一致化／Final QA）
> > - version_date: 2026-01-06（Asia/Taipei）
> > 
> > ## B. Changelog（變更清單）
> > 1) **去混讀修正**：將正文中作為補丁標記的字樣（Addendum/Appendix/Only-Add/Freeze 等）中性化為「融合承接/附錄/累積式更新/治理狀態」等不造成新舊混讀的表述；不刪減任何有效操作指引。  
> > 2) **版本/檔名一致化**：將正文內殘留的 `__260102` 與舊日期引用統一為 `__260106`／2026-01-06（Asia/Taipei），避免跨文件引用錯亂。  
> > 3) **啟動確認語補齊**：若原文缺少專案要求之啟動確認語，於檔頭後新增「啟動確認語（必貼）」章節；不改動原正文其他內容。  
> > 4) **稽核段落單一化**：以本檔末端單一稽核區塊承接（留痕與正文分離）。
> > 
> > 5) **歷史段落歸檔**：將原檔內嵌的舊版正文（如 `__251219` 段落）自正文移出，完整保留於檔尾 `Archive`，以達成去混讀且不刪減內容。  
> > 2) **Final QA 基線一致化（2026-01-06）**：版本日期更新為 2026-01-06（Asia/Taipei）；Scope 檔名映射對齊本次覆蓋輸出；重算 Hash Manifest（BODY_ONLY／FULL_EXCLUDING_HASH_LINES）。正文規則與操作指引內容不改寫、不縮水。  
> > 
> > ## C. Hash Manifest（指紋清單）
> > - hash_alg: sha256
> > - hash_body_only_sha256: eff0ac727c8b5e3c137fe77c0a7d4826b4bd273c4517ca325845241e859d8a37
> > - hash_full_excluding_hash_lines_sha256: e10a582b7b8345001f85df96f62b04aab4a81b70079d8175e7c3e55bc6536408
> > - hash_excluding_rule: FULL_EXCLUDING 係指「全檔移除所有以 `- hash_` 開頭之行」後再計算，以避免自指。
> > ## D. Audit Hand-off（裁決承接）
> > - change_id: BG-FIX-260104-0044
> > - authority_basis: HFI（人類最高決策者明確命令｜scope=BEGINNER_GUIDE｜Final QA 去混讀/一致化/啟動語補齊）
> > - governance_order_applied: DOCUMENT_INDEX → MASTER_ARCH → AI_GOV
> > - downstream_notes:
> >   - README 若仍含舊版「開新對話用語」或 Only-Add 口吻，建議後續以本檔與 TAITS_PROJECT_PROMPT 為準做同步對齊。
> > 
> > ## E. Archive（歷史留痕／自正文移出以避免混讀）
> > 
> > > 下列內容為原檔內之歷史段落／舊版本正文／混讀風險段落。已自正文移出，但內容不刪減，完整保留於此以供稽核回溯。
> > 
> > ```md
...
### SNAP-PROCESS_ANCHOR（TAITS｜程式開發流程定錨文件（Unified Process Anchor）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md）
<a id="snap-process-anchor"></a>

- 來源檔名：TAITS｜程式開發流程定錨文件（Unified Process Anchor）__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md
- 來源指紋：SHA-256=b3d9d1db2238ed58d49bae0cbdea4d8fd64de31dffdade9fedb8d738d67cc281
...
### SNAP-README（README__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md）
<a id="snap-readme"></a>

- 來源檔名：README__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md
- 來源指紋：SHA-256=385d165f7330bc366dc435f62eeff85cc627bef1b830b6adeb20beea9655f974
...
>
> ### 1) 變更清單（Changelog）
> - 修正：移除正文內既有稽核區塊（若存在），並以 Legacy Snapshot 承接於檔尾稽核區塊，避免正文／稽核邊界混讀。
> - 修正：統一 README 內部引用之現行覆蓋輸出檔名（優先指向 __CLEAN_260107 版本；避免 __PATCH1 作為現行引用）。
> - 修正：統一「治理裁決序位」表示法為唯一箭頭鏈口徑：DOCUMENT_INDEX → MASTER_ARCH → AI_GOV。
> - 保留：README 原正文內容全量承接，不做摘要縮水；僅做引用一致化與結構去混讀收斂。
>
>
> ### 2) 指紋清單（Hash Manifest）
> - HASH_METHOD：SHA-256（UTF-8，LF）
> - BODY_SHA256：c172ec3ff78778aaffed8b313dcdc257c82190bc6ff47bcd1b8823110410d2aa
> - LEGACY_AUDIT_SHA256：eddc5ff2d0e307101a13a12c29079199d7a829eba52a5a0c80bd5aa21ac762c5
>
> ### 3) 適用範圍（Scope）
> 本次覆蓋版修正範圍僅限於 doc_key=README：
> - 正文／稽核邊界去混讀（稽核區塊固定於檔尾；既有稽核內容以 Legacy Snapshot 承接）
> - 引用檔名一致化（指向本專案現行覆蓋輸出檔名）
> - 治理裁決序位表示法一致化（箭頭鏈口徑）
> - 不修改其他 doc_key 文件正文內容
>
>
> ### 4) 裁決承接（Audit Hand-off）
> - 本檔為 README 現行唯一可引用正文。
> - README 僅提供導覽與使用入口，不得作為裁決依據；裁決一律以 doc_key=DOCUMENT_INDEX 為唯一入口。
> - 若與其他治理文件存在衝突，裁決序位固定為：DOCUMENT_INDEX → MASTER_ARCH → AI_GOV。
>
>
> ### Legacy Audit Snapshot（被本次覆蓋版承接／非正文）
...
### SNAP-TAITS_PROJECT_PROMPT（TAITS_PROJECT_PROMPT__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md）
<a id="snap-taits-project-prompt"></a>

- 來源檔名：TAITS_PROJECT_PROMPT__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106__CLEAN_260107.md
- 來源指紋：SHA-256=ca6536ca8b33cadd4e0e74157e3d2698ba13a35ff9003ea0bb73fe1c6b7cccea

> # TAITS_PROJECT_PROMPT（專案專屬啟動 Prompt）
>
...
> ### 1) 變更清單（Changelog）
> - 修正：全局定錨（S1）中 L9/L10/L11 定義收斂為「Final QA 強制語義定錨」口徑。
> - 保留：原啟動 Prompt 全文承接，不做摘要縮水；僅針對定錨定義做一致化修正。
> - 保留：若原有稽核內容，已以 Legacy Snapshot 方式承接於本檔稽核區塊。
>
>
> ### 2) 指紋清單（Hash Manifest）
> - HASH_METHOD：SHA-256（UTF-8，LF）
> - BODY_SHA256：6c343d21f16986a3bb5c508ef4823435d4b0ae93784ad6365c622760b955e750
> - LEGACY_AUDIT_SHA256：744c5c931af33f83abcec78cc4a6795129defb71e2d6233f4488909a997d18c8
>
> ### 3) 適用範圍（Scope）
> 本次覆蓋版修正範圍僅限於 doc_key=TAITS_PROJECT_PROMPT：
> - 針對「全局定錨｜單一口徑（S1）」之 L9/L10/L11 定義進行一致化（強制定錨）
> - 不改寫其他治理條文語義；不新增未授權規範
>
>
> ### 4) 裁決承接（Audit Hand-off）
> - 本檔為 TAITS_PROJECT_PROMPT 現行唯一可引用正文。
> - 後續若需調整定錨口徑，必須同步更新所有含 S1 定錨段之文件（至少：BEGINNER_GUIDE、MASTER_CANON、UI_SPEC 若引用）。
> - 若與其他治理文件存在衝突，裁決序位固定為：DOCUMENT_INDEX → MASTER_ARCH → AI_GOV。
>
>
> ### Legacy Audit Snapshot（被本次覆蓋版承接／非正文）
...
> > - scope_files_output: TAITS_PROJECT_PROMPT__260106__單一正確正文版__最終覆蓋版__覆蓋輸出__FINALQA_260106.md
> > - scope_files_source: TAITS_PROJECT_PROMPT__260104__單一正確正文版__覆蓋版__覆蓋輸出.md
> > - scope_mode: FILE UPDATE MODE（doc_key 定錨／去混讀／留痕分離／Final QA）
> > - version_date: 2026-01-06（Asia/Taipei）
> > 
> > ## B. Changelog（變更清單）
> > 1) **doc_key 收斂**：將正文裁決口徑統一為 `PROJECT_PROMPT`；`TAITS_PROJECT_PROMPT` 僅保留為 Legacy Alias（非裁決）。  
> > 2) **留痕分離**：若原正文含 Scope/Changelog/Hash/Audit Hand-off（A/B/C/D）段落，已自正文移除並統一置於本檔稽核區塊。  
> > 3) **去混讀修正**：中性化補丁式字樣（Addendum/Appendix/Only-Add/POSTCHECK）為不造成裁決混讀的表述（歷史承接/附錄/累積式更新/稽核檢核）。  
> > 4) **版本一致化**：統一日期為 2026-01-06（Asia/Taipei）。
> > 5) **裁決序位口徑修正**：將檔頭 `裁決序位` 收斂為最終裁決序位 `DOCUMENT_INDEX → MASTER_ARCH → AI_GOV`（本檔受其約束，不得加入裁決鏈）。
> > 6) **章節去重收斂**：合併重複之 `全局定錨（S1）` 章節為單一章節（內容不縮水、僅重排，避免同名章節散落）。
> > 7) **上位裁決欄位收斂**：將正文中之 `上位裁決` 敘述統一改為最終裁決序位；MASTER_CANON 僅保留為平行參照（非裁決來源）。
> > 
> > 
> > ## C. Hash Manifest（指紋清單）
> > - hash_alg: sha256
> > - scope: BODY_ONLY（不含本稽核區塊）
> > - hash_value_sha256: c629f402c0f2915c787b44f47d3202ec0f1bae7a7d201a0e00cb77878ebc67f5
> > 
> > ## D. Audit Hand-off（裁決承接）
> > - change_id: PP-FINALQA-260106
> > - authority_basis: HFI（人類最高決策者明確命令｜scope=PROJECT_PROMPT｜Final QA doc_key 收斂/留痕分離/去混讀）
> > - governance_order_applied: DOCUMENT_INDEX → MASTER_ARCH → AI_GOV
> > - notes:
> >   - 建議 ACTIVE 集合僅保留本覆蓋版；原檔 `TAITS_PROJECT_PROMPT__260104__單一正確正文版__覆蓋版__覆蓋輸出.md` 封存以避免混讀。


## 稽核區塊（Audit Section｜非正文）

### 1) 變更清單（Changelog）
- 新增：建立「TAITS｜全文件彙編本（REFERENCE_COMPILATION）」單檔閱讀版。
- 保持：不改寫任何治理有效文件正文；僅以來源快照方式收錄。
- 強化：提供全量來源指紋清單與本彙編指紋，以利稽核回放。

### 2) 指紋清單（Hash Manifest）
- HASH_METHOD：SHA-256（UTF-8，LF）
- COMPILATION_BODY_SHA256：8f2b77945fe25ca9bf030186ec3f991647832ef3d33a5927cc93ee697a9ca675

### 3) 適用範圍（Scope）
- 僅適用於「閱讀/搜尋彙編」用途；不改變 DOCUMENT_INDEX 所定治理有效文件集合與裁決序位。

### 4) 裁決承接（Audit Hand-off）
- 本檔為 Reference Compilation；治理裁決仍以各 doc_key 原檔為準。
