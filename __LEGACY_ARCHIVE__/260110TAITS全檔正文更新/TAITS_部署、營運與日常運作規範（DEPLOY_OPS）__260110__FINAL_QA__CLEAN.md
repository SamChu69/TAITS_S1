...
## 8. 治理補強：Correlation Contract 與欄位貫穿規範
...
- BODY_SHA256：1ff78db0362cb86de50954f3aae62d735b369a362ff124820a817e2988c8625a

### 3) 適用範圍（Scope）
- scope_doc_key：DEPLOY_OPS
- scope_change_type：FINAL_QA_NORMALIZE（正文乾淨／去重收斂／結構重排／去標籤化／格式修復）
- scope_invariants：
  - 不改寫上位裁決序位：DOCUMENT_INDEX → MASTER_ARCH → AI_GOV
