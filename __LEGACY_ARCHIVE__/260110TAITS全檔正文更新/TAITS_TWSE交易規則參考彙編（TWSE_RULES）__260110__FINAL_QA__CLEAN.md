...
### 1) 變更清單（Changelog）
- 2026-01-10：NORMALIZE（正文乾淨／去重收斂／章節重排）。移除修補式與重複文件頭、移除 Alias/Label/順位助記與 Layer 特別化敘述；修正 Mermaid 區塊格式；保留規則彙編最大完備內容並補齊「制度更新策略／演進規則」為正常章節。

### 2) 指紋清單（Hash Manifest）
- BODY_SHA256（正文區塊）：36644b7f143cbb8b4691d98f19e888994707947a43100193080a8c0342d94a8c
