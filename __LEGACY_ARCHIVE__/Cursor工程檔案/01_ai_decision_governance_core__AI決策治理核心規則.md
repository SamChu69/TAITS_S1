...
原文範圍：
- TAITS_AI_行為與決策治理最終規則全集__251217.md：全文（含 0–16 章與最終聲明）
- TAITS_風險與合規最高否決權（RISK_COMPLIANCE）__251219.md：未引用（本工程檔僅轉譯 AI_GOV 核心規則）
-->
...
- 給出完整路徑，例如：`docs/governance/TAITS_XXX__YYMMDD.md`  
- 不得只給檔名不給資料夾  
...
## 12. 人類最終控制權（Human Final Control）
...
（End of 01_ai_decision_governance_core__AI決策治理核心規則）
